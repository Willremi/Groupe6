...
$catalogue = new MessageCatalogue('th', array (
  ...
  array (
    ...
    'This file is not a valid video.' => 'ไฟล์นี้ไม่ใช่วิดีโอที่ถูกต้อง',
    'The size of the video could not be detected.' => 'ไม่สามารถตรวจพบขนาดของวิดีโอได้',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'ความกว้างของวิดีโอใหญ่เกินไป ({{ width }}px). ความกว้างสูงสุดที่อนุญาตคือ {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'ความกว้างของวิดีโอเล็กเกินไป ({{ width }}px) ความกว้างขั้นต่ำที่คาดหวังคือ {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'ความสูงของวิดีโอสูงเกินไป ({{ height }}px). ความสูงสูงสุดที่อนุญาตคือ {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'ความสูงของวิดีโอมีขนาดเล็กเกินไป ({{ height }}px). ความสูงขั้นต่ำที่คาดไว้คือ {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'วิดีโอนี้มีพิกเซลน้อยเกินไป ({{ pixels }}). ปริมาณขั้นต่ำที่คาดไว้คือ {{ min_pixels }}.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'วิดีโอนี้มีพิกเซลมากเกินไป ({{ pixels }}). จำนวนสูงสุดที่คาดไว้คือ {{ max_pixels }}.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'อัตราส่วนวิดีโอใหญ่เกินไป ({{ ratio }}) อัตราส่วนสูงสุดที่อนุญาตคือ {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'อัตราส่วนวิดีโอเล็กเกินไป ({{ ratio }}). อัตราส่วนขั้นต่ำที่คาดหวังคือ {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'วิดีโอเป็นสี่เหลี่ยมจัตุรัส ({{ width }}x{{ height }}px). ไม่อนุญาตให้ใช้วิดีโอสี่เหลี่ยมจัตุรัส.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'วิดีโออยู่ในแนวนอน ({{ width }}x{{ height }} พิกเซล). ไม่อนุญาตวิดีโอแนวนอน',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'วิดีโอเป็นแนวตั้ง ({{ width }}x{{ height }}px) วิดีโอแนวตั้งไม่ได้รับอนุญาต',
    'The video file is corrupted.' => 'ไฟล์วิดีโอเสียหาย.',
    'The video contains multiple streams. Only one stream is allowed.' => 'วิดีโอนี้มีสตรีมหลายสตรีม อนุญาตเฉพาะสตรีมเดียวเท่านั้น',
    'Unsupported video codec "{{ codec }}".' => 'ไม่รองรับตัวแปลงสัญญาณวิดีโอ "{{ codec }}".',
    'Unsupported video container "{{ container }}".' => 'ไม่รองรับคอนเทนเนอร์วิดีโอ "{{ container }}".',
    'The image file is corrupted.' => 'ไฟล์รูปภาพเสียหาย',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'รูปภาพมีพิกเซลน้อยเกินไป ({{ pixels }}). จำนวนขั้นต่ำที่คาดไว้คือ {{ min_pixels }}.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'ภาพมีพิกเซลมากเกินไป ({{ pixels }}). จำนวนสูงสุดที่คาดไว้คือ {{ max_pixels }}.',
    'This filename does not match the expected charset.' => 'ชื่อไฟล์นี้ไม่ตรงกับชุดอักขระที่คาดไว้.',
    'This value is not valid XML.' => 'ค่านี้ไม่ใช่ XML ที่ถูกต้อง',
    'This value does not conform to the expected XSD schema.' => 'ค่านี้ไม่สอดคล้องกับสกีมา XSD ที่คาดไว้',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'เพย์โหลด XML นี้มีขนาดใหญ่เกินไป ({{ size }} ไบต์): เกินขีดจำกัด {{ limit }} ไบต์',
    'This value is not a valid cron expression.' => 'ค่านี้ไม่ใช่นิพจน์ cron ที่ถูกต้อง',
    ...
    'Please enter a valid UUID.' => 'กรุณากรอกค่า UUID ที่ถูกต้อง',
  ),
  'security' => 
  array (
