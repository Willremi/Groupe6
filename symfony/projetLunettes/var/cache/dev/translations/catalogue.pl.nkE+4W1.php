...
$catalogue = new MessageCatalogue('pl', array (
  ...
  array (
    ...
    'The filename is too long. It should have {{ filename_max_length }} character or less.|The filename is too long. It should have {{ filename_max_length }} characters or less.' => 'Nazwa pliku jest za długa. Powinna mieć {{ filename_max_length }} znak lub mniej.|Nazwa pliku jest za długa. Powinna mieć {{ filename_max_length }} znaki lub mniej.|Nazwa pliku jest za długa. Powinna mieć {{ filename_max_length }} znaków lub mniej.',
    ...
    'This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.' => 'Ta wartość jest zbyt długa. Powinna zawierać jedno słowo.|Ta wartość jest zbyt długa. Powinna zawierać {{ max }} słowa lub mniej.|Ta wartość jest zbyt długa. Powinna zawierać {{ max }} słów lub mniej.',
    ...
    'This file is not a valid video.' => 'Ten plik nie jest prawidłowym plikiem wideo.',
    'The size of the video could not be detected.' => 'Nie można wykryć rozmiaru wideo.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Szerokość wideo jest zbyt duża ({{ width }}px). Maksymalna dopuszczalna szerokość to {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Szerokość wideo jest zbyt mała ({{ width }}px). Oczekiwana minimalna szerokość to {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Wysokość wideo jest zbyt duża ({{ height }}px). Maksymalna dopuszczalna wysokość to {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Wysokość wideo jest zbyt mała ({{ height }}px). Oczekiwana minimalna wysokość to {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Wideo ma zbyt mało ({{ pixels }} pikseli). Oczekiwana minimalna liczba to {{ min_pixels }} pikseli.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Wideo ma zbyt wiele ({{ pixels }} pikseli). Oczekiwana maksymalna liczba to {{ max_pixels }} pikseli.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Współczynnik proporcji wideo jest zbyt duży ({{ ratio }}). Maksymalny dopuszczalny współczynnik to {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Współczynnik proporcji wideo jest zbyt mały ({{ ratio }}). Oczekiwany minimalny współczynnik to {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Wideo jest w formacie kwadratowym ({{ width }}x{{ height }}px). Filmy w tym formacie są niedozwolone.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Wideo ma orientację poziomą ({{ width }}x{{ height }}px). Filmy w orientacji poziomej są niedozwolone.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Wideo ma orientację pionową ({{ width }}x{{ height }}px). Filmy w orientacji pionowej są niedozwolone.',
    'The video file is corrupted.' => 'Plik wideo jest uszkodzony.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Wideo zawiera wiele strumieni. Dozwolony jest tylko jeden strumień.',
    'Unsupported video codec "{{ codec }}".' => 'Nieobsługiwany kodek wideo "{{ codec }}".',
    'Unsupported video container "{{ container }}".' => 'Nieobsługiwany kontener wideo "{{ container }}".',
    'The image file is corrupted.' => 'Plik obrazu jest uszkodzony.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Obraz ma zbyt mało ({{ pixels }} pikseli). Oczekiwana minimalna liczba to {{ min_pixels }} pikseli.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Obraz ma zbyt wiele ({{ pixels }} pikseli). Oczekiwana maksymalna liczba to {{ max_pixels }} pikseli.',
    'This filename does not match the expected charset.' => 'Ta nazwa pliku nie odpowiada oczekiwanemu zestawowi znaków.',
    'This value is not valid XML.' => 'Ta wartość nie jest prawidłowym XML.',
    'This value does not conform to the expected XSD schema.' => 'Ta wartość nie jest zgodna z oczekiwanym schematem XSD.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Ten XML jest zbyt duży ({{ size }} bajtów): przekracza limit {{ limit }} bajtów.',
    'This value is not a valid cron expression.' => 'Ta wartość nie jest prawidłowym wyrażeniem cron.',
    ...
    'Please enter a valid UUID.' => 'Proszę podać prawidłowy UUID.',
  ),
  'security' => 
  array (
