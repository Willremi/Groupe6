...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'This file is not a valid video.' => 'Этот файл не является корректным видео.',
    'The size of the video could not be detected.' => 'Не удалось определить размер видео.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Ширина видео слишком велика ({{ width }}px). Максимально допустимая ширина {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Ширина видео слишком мала ({{ width }}px). Минимально допустимая ширина {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Высота видео слишком велика ({{ height }}px). Максимально допустимая высота {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Высота видео слишком мала ({{ height }}px). Минимально допустимая высота {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'В видео слишком мало пикселей ({{ pixels }} пикселей). Минимально допустимое количество {{ min_pixels }} пикселей.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'В видео слишком много пикселей ({{ pixels }} пикселей). Максимально допустимое количество {{ max_pixels }} пикселей.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Соотношение сторон видео слишком велико ({{ ratio }}). Максимально допустимое соотношение {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Соотношение сторон видео слишком мало ({{ ratio }}). Минимально допустимое соотношение {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Видео квадратное ({{ width }}x{{ height }}px). Квадратные видео не разрешены.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Видео в альбомной ориентации ({{ width }}x{{ height }}px). Видео в альбомной ориентации не разрешены.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Видео в портретной ориентации ({{ width }}x{{ height }}px). Видео в портретной ориентации не разрешены.',
    ...
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'В изображении слишком мало пикселей ({{ pixels }} пикселей). Минимально допустимое количество {{ min_pixels }} пикселей.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'В изображении слишком много пикселей ({{ pixels }} пикселей). Максимально допустимое количество {{ max_pixels }} пикселей.',
    'This filename does not match the expected charset.' => 'Это имя файла не соответствует ожидаемой кодировке.',
    'This value is not valid XML.' => 'Это значение не является корректным XML.',
    'This value does not conform to the expected XSD schema.' => 'Это значение не соответствует ожидаемой схеме XSD.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Эта полезная нагрузка XML слишком велика ({{ size }} байт): она превышает ограничение в {{ limit }} байт.',
    'This value is not a valid cron expression.' => 'Это значение не является корректным выражением cron.',
    ...
    'Please enter a valid UUID.' => 'Пожалуйста, введите действительный UUID.',
  ),
  'security' => 
  array (
