...
$catalogue = new MessageCatalogue('sr_Latn', array (
  ...
  array (
    ...
    'This value should satisfy at least one of the following constraints:' => 'Ova vrednost treba da zadovoljava najmanje jedno od narednih ograničenja:',
    ...
    'This value is not a valid Twig template.' => 'Ova vrednost nije ispravan Twig šablon.',
    'This file is not a valid video.' => 'Fajl nije u ispravnom video formatu.',
    'The size of the video could not be detected.' => 'Nije moguće utvrditi veličinu video snimka.',
    ...
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Odnos širine i visine videa je prevelik ({{ ratio }}). Dozvoljeni maksimalni odnos je {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Odnos širine i visine videa je previše mali ({{ ratio }}). Očekivani minimalni odnos je {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Video je kvadratnog oblika ({{ width }}x{{ height }}px). Video zapisi kvadratnog oblika nisu dozvoljeni.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Video je u vodoravnoj orijentaciji ({{ width }}x{{ height }} px). Video zapisi u vodoravnoj orijentaciji nisu dozvoljeni.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Video je u vertikalnoj orijentaciji ({{ width }}x{{ height }}px). Video zapisi u vertikalnoj orijentaciji nisu dozvoljeni.',
    ...
    'The image file is corrupted.' => 'Slika je oštećena.',
    ...
    'This value is not valid XML.' => 'Ova vrednost nije važeći XML.',
    'This value does not conform to the expected XSD schema.' => 'Ova vrednost ne odgovara očekivanoj XSD šemi.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Ovaj XML sadržaj je prevelik ({{ size }} bajtova): premašuje ograničenje od {{ limit }} bajtova.',
    'This value is not a valid cron expression.' => 'Ova vrednost nije važeći cron izraz.',
    ...
    'Please enter a valid UUID.' => 'Molim upišite ispravan UUID.',
  ),
  'security' => 
  array (
