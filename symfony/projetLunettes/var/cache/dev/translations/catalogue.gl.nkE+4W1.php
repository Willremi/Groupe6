...
$catalogue = new MessageCatalogue('gl', array (
  ...
  array (
    ...
    'The password strength is too low. Please use a stronger password.' => 'O contrasinal é demasiado débil. Utilice un contrasinal máis seguro.',
    ...
    'Using invisible characters is not allowed.' => 'Non se permite usar caracteres invisíbeis.',
    ...
    'This URL is missing a top-level domain.' => 'A esta URL fáltalle un dominio de nivel superior.',
    'This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.' => 'Este valor é curto de máis. Debe conter polo menos unha palabra.|Este valor é curto de máis. Debe conter polo menos {{ min }} palabras.',
    'This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.' => 'Este valor é longo de máis. Debe conter só unha palabra.|Este valor é longo de máis. Debe conter {{ max }} palabras ou menos.',
    ...
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'A anchura do vídeo é demasiado grande ({{ width }}px). A anchura máxima permitida é {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'A anchura do vídeo é demasiado pequena ({{ width }}px). A anchura mínima agardada é {{ min_width }}px.',
    ...
    'This filename does not match the expected charset.' => 'Este nome de ficheiro non coincide co charset agardado.',
    'This value is not valid XML.' => 'Este valor non é un XML válido.',
    'This value does not conform to the expected XSD schema.' => 'Este valor non se axusta ao esquema XSD esperado.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Esta carga útil XML é demasiado grande ({{ size }} bytes): supera o límite de {{ limit }} bytes.',
    'This value is not a valid cron expression.' => 'Este valor non é unha expresión cron válida.',
    ...
    'Please enter a valid UUID.' => 'Por favor, introduce un UUID válido.',
  ),
  'security' => 
  array (
    ...
    'Too many failed login attempts, please try again in %minutes% minutes.' => 'Demasiados intentos errados de inicio de sesión, inténtao de novo en %minutes% minutos.',
  ),
));
