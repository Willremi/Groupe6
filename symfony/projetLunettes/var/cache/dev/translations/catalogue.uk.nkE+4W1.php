...
$catalogue = new MessageCatalogue('uk', array (
  ...
  array (
    ...
    'This file is not a valid video.' => 'Цей файл не є допустимим відеофайлом.',
    'The size of the video could not be detected.' => 'Не вдалося визначити розмір відеофайлу.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Ширина відеофайлу занадто велика ({{ width }}px). Максимально допустима ширина {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Ширина відеофайлу занадто мала ({{ width }}px). Мінімально допустима ширина {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Висота відеофайлу занадто велика ({{ height }}px). Максимально допустима висота {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Висота відеофайлу занадто мала ({{ height }}px). Мінімально допустима висота {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Кількість пікселів у відеофайлі занадто мала ({{ pixels }} пікселів). Мінімально допустима кількість {{ min_pixels }} пікселів.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Кількість пікселів у відеофайлі занадто велика ({{ pixels }} пікселів). Максимально допустима кількість {{ max_pixels }} пікселів.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Співвідношення сторін відеофайлу занадто велике ({{ ratio }}). Максимально допустиме співвідношення сторін {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Співвідношення сторін відеофайлу занадто мале ({{ ratio }}). Мінімально допустиме співвідношення сторін {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => ' Відеофайл має квадратні пропорції ({{ width }}x{{ height }}px). Квадратні відеофайли не дозволені.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Відеофайл в альбомній орієнтації ({{ width }}x{{ height }}px). Відеофайли в альбомній орієнтації не дозволені.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Відеофайл у портретній орієнтації ({{ width }}x{{ height }}px). Відеофайли у портретній орієнтації не дозволені.',
    'The video file is corrupted.' => 'Відеофайл пошкоджено.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Відеофайл містить кілька потоків. Дозволено лише один потік.',
    'Unsupported video codec "{{ codec }}".' => 'Непідтримуваний відеокодек «{{ codec }}».',
    'Unsupported video container "{{ container }}".' => 'Непідтримуваний відеоконтейнер "{{ container }}".',
    'The image file is corrupted.' => 'Файл зображення пошкоджено.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Кількість пікселів у зображенні занадто мала ({{ pixels }} пікселів). Мінімально допустима кількість {{ min_pixels }} пікселів.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Кількість пікселів у зображенні занадто велика ({{ pixels }} пікселів). Максимально допустима кількість {{ max_pixels }} пікселів.',
    'This filename does not match the expected charset.' => 'Назва файлу не відповідає очікуваному набору символів.',
    'This value is not valid XML.' => 'Це значення не є дійсним XML.',
    'This value does not conform to the expected XSD schema.' => 'Це значення не відповідає очікуваній XSD схемі.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Ці XML-дані занадто великі ({{ size }} байт): вони перевищують ліміт у {{ limit }} байт.',
    'This value is not a valid cron expression.' => 'Це значення не є дійсним cron-виразом.',
    ...
    'Please enter a valid UUID.' => 'Будь ласка, введіть дійсний UUID.',
  ),
  'security' => 
  array (
