...
$catalogue = new MessageCatalogue('tl', array (
  ...
  array (
    ...
    'No temporary folder was configured in php.ini.' => 'Walang pansamantalang folder na na-configure sa php.ini, o hindi umiiral ang na-configure na folder.',
    ...
    'This value is not a valid Twig template.' => 'Ang halagang ito ay hindi wastong Twig template.',
    'This file is not a valid video.' => 'Ang file na ito ay hindi wastong video.',
    'The size of the video could not be detected.' => 'Hindi matukoy ang laki ng video.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Masyadong malaki ang lapad ng video ({{ width }}px). Ang pinakamalaking pinapayagang lapad ay {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Masyadong maliit ang lapad ng video ({{ width }}px). Ang inaasahang pinakamababang lapad ay {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Masyadong malaki ang taas ng video ({{ height }}px). Ang pinakamalaking pinapayagang taas ay {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Masyadong maliit ang taas ng video ({{ height }}px). Ang inaasahang pinakamababang taas ay {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Masyadong kakaunti ang mga pixel ng video ({{ pixels }}). Ang inaasahang pinakamababang bilang ay {{ min_pixels }}.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Masyadong marami ang mga pixel ng video ({{ pixels }}). Ang inaasahang pinakamataas na bilang ay {{ max_pixels }}.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Masyadong malaki ang ratio ng video ({{ ratio }}). Ang pinakamalaking pinapayagang ratio ay {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Masyadong maliit ang ratio ng video ({{ ratio }}). Ang inaasahang pinakamababang ratio ay {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Parisukat ang video ({{ width }}x{{ height }}px). Hindi pinapayagan ang mga parisukat na video.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Naka-landscape ang video ({{ width }}x{{ height }}px). Hindi pinapayagan ang mga video na naka-landscape.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Naka-portrait ang video ({{ width }}x{{ height }}px). Hindi pinapayagan ang mga video na naka-portrait.',
    'The video file is corrupted.' => 'Sira ang video file.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Maraming stream ang video. Iisang stream lamang ang pinapayagan.',
    'Unsupported video codec "{{ codec }}".' => 'Hindi suportadong video codec "{{ codec }}".',
    'Unsupported video container "{{ container }}".' => 'Hindi suportadong video container "{{ container }}".',
    'The image file is corrupted.' => 'Sira ang file ng larawan.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Masyadong kakaunti ang mga pixel ng larawan ({{ pixels }}). Ang inaasahang pinakamababang bilang ay {{ min_pixels }}.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Masyadong marami ang mga pixel ng larawan ({{ pixels }}). Ang inaasahang pinakamataas na bilang ay {{ max_pixels }}.',
    'This filename does not match the expected charset.' => 'Ang pangalan ng file na ito ay hindi tumutugma sa inaasahang charset.',
    'This value is not valid XML.' => 'Ang nilalaman na ito ay hindi wastong XML.',
    'This value does not conform to the expected XSD schema.' => 'Ang nilalaman na ito ay hindi tumutugma sa inaasahang XSD schema.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Masyadong malaki ang XML payload na ito ({{ size }} bytes): lumampas ito sa limitasyong {{ limit }} bytes.',
    'This value is not a valid cron expression.' => 'Ang halagang ito ay hindi wastong cron expression.',
    ...
    'Please enter a valid UUID.' => 'Pakilagay ang wastong UUID.',
  ),
  'security' => 
  array (
