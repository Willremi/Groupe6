...
$catalogue = new MessageCatalogue('nn', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => 'Denne verdien er ikkje ein gyldig IP-adresse.',
    ...
    'No temporary folder was configured in php.ini.' => 'Ingen midlertidig mappe var konfigurert i php.ini, eller den konfigurerte mappa eksisterer ikkje.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'Denne verdien er ikkje eit gyldig internasjonalt bankkontonummer (IBAN).',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Denne verdien er ikkje ein gyldig forretningsidentifikasjonskode (BIC).',
    'Error' => 'Feil',
    'This is not a valid UUID.' => 'Denne verdien er ikkje ein gyldig UUID.',
    ...
    'The filename is too long. It should have {{ filename_max_length }} character or less.|The filename is too long. It should have {{ filename_max_length }} characters or less.' => 'Filnamnet er for langt. Det bør ha {{ filename_max_length }} teikn eller færre.|Filnamnet er for langt. Det bør ha {{ filename_max_length }} teikn eller færre.',
    'The password strength is too low. Please use a stronger password.' => 'Passordstyrken er for låg. Vennligst bruk eit sterkare passord.',
    'This value contains characters that are not allowed by the current restriction-level.' => 'Denne verdien inneheld teikn som ikkje er tillatne av det gjeldande restriksjonsnivået.',
    'Using invisible characters is not allowed.' => 'Det er ikkje tillate å bruke usynlege teikn.',
    'Mixing numbers from different scripts is not allowed.' => 'Det er ikkje tillate å blande tal frå forskjellige skript.',
    'Using hidden overlay characters is not allowed.' => 'Det er ikkje tillate å bruke skjulte overleggsteikn.',
    ...
    'This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.' => 'Denne verdien er for kort. Han bør innehalde minst eitt ord.|Denne verdien er for kort. Han bør innehalde minst {{ min }} ord.',
    'This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.' => 'Denne verdien er for lang. Han bør innehalde berre eitt ord.|Denne verdien er for lang. Han bør innehalde {{ max }} ord eller færre.',
    'This value does not represent a valid week in the ISO 8601 format.' => 'Denne verdien representerer ikkje ein gyldig veke i ISO 8601-formatet.',
    'This value is not a valid week.' => 'Denne verdien er ikkje ei gyldig veke.',
    'This value should not be before week "{{ min }}".' => 'Denne verdien bør ikkje vere før veke "{{ min }}".',
    'This value should not be after week "{{ max }}".' => 'Denne verdien bør ikkje vere etter veke "{{ max }}".',
    'This value is not a valid Twig template.' => 'Denne verdien er ikkje ein gyldig Twig-mal.',
    'This file is not a valid video.' => 'Denne fila er ikkje ein gyldig video.',
    'The size of the video could not be detected.' => 'Storleiken på videoen kunne ikkje oppdagast.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Videobreidda er for stor ({{ width }}px). Tillaten maksimal breidde er {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Videobreidda er for lita ({{ width }}px). Forventa minimumsbreidde er {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Videoen si høgd er for stor ({{ height }}px). Tillaten maksimal høgd er {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Videohøgda er for lita ({{ height }}px). Forventa minstehøgd er {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Videoen har for få pikslar ({{ pixels }}). Forventa minimum er {{ min_pixels }}.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Videoen har for mange pikslar ({{ pixels }}). Forventa maksimalt tal er {{ max_pixels }}.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Videoforholdet er for stort ({{ ratio }}). Tillaten maksimal forhold er {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Videoforholdet er for lite ({{ ratio }}). Forventa minimumsforhold er {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Videoen er kvadratisk ({{ width }}x{{ height }}px). Kvadratiske videoar er ikkje tillatne.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Videoen er i liggjande format ({{ width }}x{{ height }} px). Liggjande videoar er ikkje tillatne.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Videoen er i portrettformat ({{ width }}x{{ height }}px). Portrettvideoar er ikkje tillatne.',
    'The video file is corrupted.' => 'Videofila er skadd.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Videoen inneheld fleire straumar. Berre éin straum er tillaten.',
    'Unsupported video codec "{{ codec }}".' => 'Ikkje støtta videokodek «{{ codec }}».',
    'Unsupported video container "{{ container }}".' => 'Ikkje-støtta videokontainer "{{ container }}".',
    'The image file is corrupted.' => 'Bildefila er skadd.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Biletet har for få pikslar ({{ pixels }}). Forventa minimum er {{ min_pixels }}.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Biletet har for mange pikslar ({{ pixels }}). Forventa maksimalt tal er {{ max_pixels }}.',
    'This filename does not match the expected charset.' => 'Dette filnamnet samsvarar ikkje med forventa teiknsett.',
    'This value is not valid XML.' => 'Denne verdien er ikkje gyldig XML.',
    'This value does not conform to the expected XSD schema.' => 'Denne verdien samsvarar ikkje med det forventa XSD-skjemaet.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Denne XML-nyttelasta er for stor ({{ size }} byte): ho overskrid grensa på {{ limit }} byte.',
    'This value is not a valid cron expression.' => 'Denne verdien er ikkje eit gyldig cron-uttrykk.',
    ...
    'Please enter a valid UUID.' => 'Gje opp ein gyldig UUID.',
  ),
  'security' => 
  array (
...
$catalogueNo = new MessageCatalogue('no', array (
  ...
  array (
    ...
    'This value is not valid XML.' => 'Denne verdien er ikke gyldig XML.',
    'This value does not conform to the expected XSD schema.' => 'Denne verdien samsvarer ikke med det forventede XSD-skjemaet.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Denne XML-nyttelasten er for stor ({{ size }} byte): den overskrider grensen på {{ limit }} byte.',
    'This value is not a valid cron expression.' => 'Denne verdien er ikke et gyldig cron-uttrykk.',
    ...
    'Please enter a valid UUID.' => 'Vennligst skriv inn en gyldig UUID.',
  ),
  'security' => 
  array (
