...
$catalogue = new MessageCatalogue('cs', array (
  ...
  array (
    ...
    'The image width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Obrázek je příliš široký ({{ width }}px). Maximální povolená šířka je {{ max_width }}px.',
    'The image width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Obrázek je příliš úzký ({{ width }}px). Minimální očekávaná šířka je {{ min_width }}px.',
    'The image height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Obrázek je příliš vysoký ({{ height }}px). Maximální povolená výška je {{ max_height }}px.',
    'The image height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Obrázek je příliš nízký ({{ height }}px). Minimální očekávaná výška je {{ min_height }}px.',
    ...
    'The image ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Poměr stran obrázku je příliš velký ({{ ratio }}). Maximální povolený poměr stran je {{ max_ratio }}.',
    'The image ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Poměr stran obrázku je příliš malý ({{ ratio }}). Minimální očekávaný poměr stran je {{ min_ratio }}.',
    'The image is square ({{ width }}x{{ height }}px). Square images are not allowed.' => 'Obrázek je čtvercový ({{ width }}x{{ height }}px). Čtvercové obrázky nejsou povolené.',
    ...
    'This file is not a valid video.' => 'Tento soubor není video.',
    'The size of the video could not be detected.' => 'Nepodařily se zjistit rozměry videa.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Video je příliš široké ({{ width }}px). Maximální povolená šířka je {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Video je příliš úzké ({{ width }}px). Minimální očekávaná šířka je {{ min_width }} px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Video je příliš vysoké ({{ height }}px). Maximální povolená výška je {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Video je příliš nízké ({{ height }}px). Minimální očekávaná výška je {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Video má příliš málo pixelů ({{ pixels }} pixelů). Minimální očekávané množství je {{ min_pixels }} pixelů.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Video má příliš mnoho pixelů ({{ pixels }} pixelů). Maximální očekávané množství je {{ max_pixels }} pixelů.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Poměr stran videa je příliš velký ({{ ratio }}). Maximální povolený poměr stran je {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Poměr stran videa je příliš malý ({{ ratio }}). Minimální očekávaný poměr stran je {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Video je čtvercové ({{ width }}x{{ height }}px). Čtvercová videa nejsou povolená.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Video je orientované na šířku ({{ width }}x{{ height }} px). Videa orientovaná na šířku nejsou povolená.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Video je orientované na výšku ({{ width }}x{{ height }} px). Videa orientovaná na výšku nejsou povolená.',
    'The video file is corrupted.' => 'Soubor videa je poškozený.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Video obsahuje více proudů. Povolen je pouze jeden proud.',
    'Unsupported video codec "{{ codec }}".' => 'Nepodporovaný kodek videa "{{ codec }}".',
    'Unsupported video container "{{ container }}".' => 'Nepodporovaný kontejner videa "{{ container }}".',
    'The image file is corrupted.' => 'Soubor obrázku je poškozený.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Obrázek má příliš málo pixelů ({{ pixels }} pixelů). Minimální očekávané množství je {{ min_pixels }} pixelů.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Obrázek má příliš mnoho pixelů ({{ pixels }} pixelů). Maximální očekávané množství je {{ max_pixels }} pixelů.',
    'This filename does not match the expected charset.' => 'Tento název souboru neodpovídá očekávané znakové sadě.',
    'This value is not valid XML.' => 'Tato hodnota není platné XML.',
    'This value does not conform to the expected XSD schema.' => 'Tato hodnota neodpovídá očekávanému schématu XSD.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Tato datová část XML je příliš velká ({{ size }} bajtů): překračuje limit {{ limit }} bajtů.',
    'This value is not a valid cron expression.' => 'Tato hodnota není platný výraz cron.',
    ...
    'Please enter a valid UUID.' => 'Prosím zadejte platný UUID.',
  ),
  'security' => 
  array (
