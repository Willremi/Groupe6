...
$catalogue = new MessageCatalogue('hy', array (
  ...
  array (
    ...
    'This file is not a valid video.' => 'Այս ֆայլը վավեր տեսանյութ չէ։',
    'The size of the video could not be detected.' => 'Չհաջողվեց հայտնաբերել տեսանյութի չափը.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Տեսահոլովակի լայնությունը չափազանց մեծ է ({{ width }}px)։ Թույլատրելի առավելագույն լայնությունը {{ max_width }}px է։',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Տեսանյութի լայնությունը չափազանց փոքր է ({{ width }}px). Սպասվող նվազագույն լայնքը {{ min_width }}px է.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Վիդեոյի բարձրությունը չափազանց մեծ է ({{ height }}px)։ Թույլատրելի առավելագույն բարձրությունը {{ max_height }}px է։',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Վիդեոյի բարձրությունը շատ փոքր է ({{ height }}px)։ Սպասվող նվազագույն բարձրությունը {{ min_height }}px է։',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Տեսանյութը ունի չափազանց քիչ պիքսելներ ({{ pixels }}). Սպասվող նվազագույն քանակը {{ min_pixels }} է։',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Տեսանյութը ունի չափազանց շատ պիքսելներ ({{ pixels }}). Սպասվող առավելագույն քանակը {{ max_pixels }} է։',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Տեսանյութի հարաբերակցությունը չափազանց մեծ է ({{ ratio }}): Թույլատրելի առավելագույն հարաբերակցությունը {{ max_ratio }} է։',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Վիդեոյի հարաբերակցությունը շատ փոքր է ({{ ratio }}). Ավելի փոքրագույն սպասվող հարաբերակցությունը {{ min_ratio }} է.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Տեսանյութը քառակուսի է ({{ width }}x{{ height }}px). Քառակուսի տեսանյութերը թույլատրելի չեն.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Տեսանյութը հորիզոնական կողմնորոշմամբ է ({{ width }}x{{ height }} px). Հորիզոնական տեսանյութերը թույլատրելի չեն.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Վիդեոն ուղղահայաց կողմնորոշված է ({{ width }}x{{ height }}px)։ Ուղղահայաց կողմնորոշմամբ տեսանյութերը թույլատրելի չեն։',
    'The video file is corrupted.' => 'Տեսանյութի ֆայլը վնասված է.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Տեսանյութը պարունակում է բազմաթիվ հոսքեր։ Թույլատրվում է միայն մեկ հոսք։',
    'Unsupported video codec "{{ codec }}".' => 'Չաջակցվող տեսանյութի կոդեկ «{{ codec }}»։',
    'Unsupported video container "{{ container }}".' => 'Չաջակցվող վիդեո կոնտեյներ "{{ container }}".',
    'The image file is corrupted.' => 'Պատկերի ֆայլը վնասված է։',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Պատկերը ունի չափազանց քիչ պիքսելներ ({{ pixels }}). Սպասվող նվազագույնը {{ min_pixels }} է։',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Պատկերը ունի չափազանց շատ պիքսել ({{ pixels }}). Սպասվող առավելագույն քանակը {{ max_pixels }} է.',
    'This filename does not match the expected charset.' => 'Այս ֆայլի անունը չի համապատասխանում սպասվող նիշքերի հավաքածուին.',
    'This value is not valid XML.' => 'Այս արժեքը վավեր XML չէ։',
    'This value does not conform to the expected XSD schema.' => 'Այս արժեքը չի համապատասխանում սպասվող XSD սխեմային։',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Այս XML բեռնվածքը չափազանց մեծ է ({{ size }} բայթ)՝ այն գերազանցում է {{ limit }} բայթ սահմանը։',
    'This value is not a valid cron expression.' => 'Այս արժեքը վավեր cron արտահայտություն չէ։',
    ...
    'Please enter a valid UUID.' => 'Մուտքագրեք վավեր UUID։',
  ),
  'security' => 
  array (
