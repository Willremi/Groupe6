...
$catalogue = new MessageCatalogue('sk', array (
  ...
  array (
    ...
    'This value is not valid XML.' => 'Táto hodnota nie je platné XML.',
    'This value does not conform to the expected XSD schema.' => 'Táto hodnota nezodpovedá očakávanej schéme XSD.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Táto dátová časť XML je príliš veľká ({{ size }} bajtov): prekračuje limit {{ limit }} bajtov.',
    'This value is not a valid cron expression.' => 'Táto hodnota nie je platný výraz cron.',
    ...
    'Please enter a valid UUID.' => 'Prosím zadajte platný UUID.',
  ),
  'security' => 
  array (
