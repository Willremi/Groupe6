...
$catalogue = new MessageCatalogue('el', array (
  ...
  array (
    ...
    'This value is not valid XML.' => 'Αυτή η τιμή δεν είναι έγκυρη XML.',
    'This value does not conform to the expected XSD schema.' => 'Αυτή η τιμή δεν συμμορφώνεται με το αναμενόμενο σχήμα XSD.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Αυτό το ωφέλιμο φορτίο XML είναι πολύ μεγάλο ({{ size }} bytes): υπερβαίνει το όριο των {{ limit }} bytes.',
    'This value is not a valid cron expression.' => 'Αυτή η τιμή δεν είναι έγκυρη έκφραση cron.',
    ...
    'Please enter a valid UUID.' => 'Παρακαλούμε εισάγετε ένα έγκυρο UUID.',
  ),
  'security' => 
  array (
  ...
  'VerifyEmailBundle' => 
  array (
    '%count% year|%count% years' => '%count% έτος|%count% έτη',
    '%count% month|%count% months' => '%count% μήνας|%count% μήνες',
    '%count% day|%count% days' => '%count% ημέρα|%count% ημέρες',
    '%count% hour|%count% hours' => '%count% ώρα|%count% ώρες',
    '%count% minute|%count% minutes' => '%count% λεπτό|%count% λεπτά',
    'The link to verify your email has expired. Please request a new link.' => 'Ο σύνδεσμος για την επαλήθευση του ηλεκτρονικού ταχυδρομείου σας έχει λήξει. Παρακαλούμε ζητήστε νέο σύνδεσμο.',
    'The link to verify your email is invalid. Please request a new link.' => 'Ο σύνδεσμος για την επαλήθευση του ηλεκτρονικού ταχυδρομείου σας δεν είναι έγκυρος. Παρακαλούμε ζητήστε νέο σύνδεσμο.',
    'The link to verify your email appears to be for a different account or email. Please request a new link.' => 'Ο σύνδεσμος για την επαλήθευση του ηλεκτρονικού ταχυδρομείου σας φαίνεται να είναι για διαφορετικό λογαριασμό ή για άλλη διεύθυνση ηλεκτρονικού ταχυδρομείου. Παρακαλούμε ζητήστε νέο σύνδεσμο.',
  ),
));
