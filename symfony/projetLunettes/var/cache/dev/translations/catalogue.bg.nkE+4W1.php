...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.' => 'Стойността е твърде кратка. Трябва да съдържа поне една дума.|Стойността е твърде кратка. Трябва да съдържа поне {{ min }} думи.',
    'This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.' => 'Стойността е твърде дълга. Трябва да съдържа само една дума.|Стойността е твърде дълга. Трябва да съдържа {{ max }} думи или по-малко.',
    ...
    'This value should not be before week "{{ min }}".' => 'Стойността не трябва да бъде преди седмица "{{ min }}".',
    ...
    'This file is not a valid video.' => 'Този файл не е валидно видео.',
    'The size of the video could not be detected.' => 'Размерът на видеото не може да бъде установен.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Ширината на видеото е твърде голяма ({{ width }}px). Допустимата максимална ширина е {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Ширината на видеото е твърде малка ({{ width }}px). Минималната изисквана ширина е {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Височината на видеото е твърде голяма ({{ height }}px). Максимално допустимата височина е {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Височината на видеото е твърде малка ({{ height }}px). Очакваната минимална височина е {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Видеото има твърде малко пиксели ({{ pixels }}). Минимално изискуемото количество е {{ min_pixels }}.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Видеото има твърде много пиксели ({{ pixels }}). Максималният допустим брой е {{ max_pixels }}.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Съотношението на видеото е твърде голямо ({{ ratio }}). Позволеното максимално съотношение е {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Съотношението на видеото е твърде малко ({{ ratio }}). Минималното очаквано съотношение е {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Видеото е квадратно ({{ width }}x{{ height }}px). Квадратни видеа не са позволени.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Видеото е в хоризонтална ориентация ({{ width }}x{{ height }}px). Хоризонтални видеа не са позволени.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Видеото е с портретна ориентация ({{ width }}x{{ height }}px). Видеа с портретна ориентация не са позволени.',
    'The video file is corrupted.' => 'Видеофайлът е повреден.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Видеото съдържа множество потоци. Разрешен е само един поток.',
    'Unsupported video codec "{{ codec }}".' => 'Неподдържан видео кодек „{{ codec }}“.',
    'Unsupported video container "{{ container }}".' => 'Неподдържан видео контейнер "{{ container }}".',
    'The image file is corrupted.' => 'Файлът с изображение е повреден.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Изображението има твърде малко пиксели ({{ pixels }}). Минималният изискуем брой е {{ min_pixels }}.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Изображението има твърде много пиксели ({{ pixels }}). Максималният допустим брой е {{ max_pixels }}.',
    'This filename does not match the expected charset.' => 'Името на файла не съответства на очаквания набор от знаци.',
    'This value is not valid XML.' => 'Тази стойност не е валиден XML.',
    'This value does not conform to the expected XSD schema.' => 'Тази стойност не съответства на очакваната XSD схема.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Този XML е твърде голям ({{ size }} байта): надвишава ограничението от {{ limit }} байта.',
    'This value is not a valid cron expression.' => 'Тази стойност не е валиден cron израз.',
    ...
    'Please enter a valid UUID.' => 'Моля въведете валиден UUID.',
  ),
  'security' => 
  array (
