...
$catalogue = new MessageCatalogue('af', array (
  ...
  array (
    ...
    'You must select at least {{ limit }} choice.|You must select at least {{ limit }} choices.' => 'Jy moet ten minste {{ limit }} keuse kies.|Jy moet ten minste {{ limit }} keuses kies.',
    ...
    'No temporary folder was configured in php.ini.' => 'Geen tydelike vouer is in php.ini gekonfigureer nie, of die gekonfigureerde vouer bestaan ​​nie.',
    ...
    'This collection should contain {{ limit }} element or less.|This collection should contain {{ limit }} elements or less.' => 'Hierdie versameling moet {{ limit }} element of minder bevat.|Hierdie versameling moet {{ limit }} elemente of minder bevat.',
    ...
    'The filename is too long. It should have {{ filename_max_length }} character or less.|The filename is too long. It should have {{ filename_max_length }} characters or less.' => 'Die lêernaam is te lank. Dit moet {{ filename_max_length }} karakters of minder hê.|Die lêernaam is te lank. Dit moet {{ filename_max_length }} karakters of minder hê.',
    'The password strength is too low. Please use a stronger password.' => 'Die wachtwoord sterkte is te laag. Gebruik asseblief \'een sterker wachtwoord.',
    ...
    'Using hidden overlay characters is not allowed.' => 'Die gebruik van verborgen oorvleuelende karakters word nie toegelaat nie.',
    'The extension of the file is invalid ({{ extension }}). Allowed extensions are {{ extensions }}.' => 'Die uitbreiding van de lêer is ongeldig ({{ extension }}). Toegelaten uitbreidings is {{ extensions }}.',
    ...
    'This value should not be before week "{{ min }}".' => 'Hierdie waarde mag niet voor week "{{ min }}" wees nie.',
    ...
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Die videohoogte is te groot ({{ height }}px). Toegestane maximum hoogte is {{ max_height }}px.',
    ...
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Die video het te min pixels ({{ pixels }}). Minimum hoeveelheid verwag is {{ min_pixels }} pixels.',
    ...
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Die beeld het te veel pixels ({{ pixels }}). Maksimum verwagte aantal is {{ max_pixels }} pixels.',
    'This filename does not match the expected charset.' => 'Hierdie lêernaam stem nie ooreen met die verwagte karakterstel nie.',
    'This value is not valid XML.' => 'Hierdie waarde is nie geldige XML nie.',
    'This value does not conform to the expected XSD schema.' => 'Hierdie waarde voldoen nie aan die verwagte XSD-skema nie.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Hierdie XML-loonvrag is te groot ({{ size }} grepe): dit oorskry die limiet van {{ limit }} grepe.',
    'This value is not a valid cron expression.' => 'Hierdie waarde is nie \'n geldige cron-uitdrukking nie.',
    ...
    'Please enter a valid UUID.' => 'Voer assblief \'n geldige UUID in.',
  ),
  'security' => 
  array (
