...
$catalogue = new MessageCatalogue('tr', array (
  ...
  array (
    ...
    'This file is not a valid video.' => 'Bu dosya geçerli bir video dosyası değil.',
    'The size of the video could not be detected.' => 'Videonun boyutu tespit edilemedi.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'Video genişliği çok büyük ({{ width }}px). İzin verilen maksimum genişlik {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'Video genişliği çok küçük ({{ width }}px). Beklenen minimum genişlik {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'Video yüksekliği çok büyük ({{ height }}px). İzin verilen maksimum yükseklik {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'Video yüksekliği çok küçük ({{ height }}px). Beklenen minimum yükseklik {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Videodaki piksel sayısı çok az ({{ pixels }} piksel). Beklenen minimum miktar {{ min_pixels }} pikseldir.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Videodaki piksel sayısı çok fazla ({{ pixels }} piksel). Beklenen maksimum miktar {{ max_pixels }} pikseldir.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'Video oranı çok büyük ({{ ratio }}). İzin verilen maksimum oran {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'Video oranı çok küçük ({{ ratio }}). Beklenen minimum oran {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'Video kare biçimde ({{ width }}x{{ height }}px). Kare videolara izin verilmez.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'Video yatay biçimde ({{ width }}x{{ height }}px). Yatay videolara izin verilmez.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'Video dikey biçimde ({{ width }}x{{ height }}px). Dikey videolara izin verilmez.',
    'The video file is corrupted.' => 'Video dosyası bozuk.',
    'The video contains multiple streams. Only one stream is allowed.' => 'Video birden fazla akış içeriyor. Yalnızca tek akışa izin verilir.',
    'Unsupported video codec "{{ codec }}".' => 'Desteklenmeyen video codec\'i "{{ codec }}".',
    'Unsupported video container "{{ container }}".' => 'Desteklenmeyen video kapsayıcısı "{{ container }}".',
    'The image file is corrupted.' => 'Görüntü dosyası bozulmuş.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'Görüntüdeki piksel sayısı çok az ({{ pixels }}). Beklenen minimum miktar {{ min_pixels }}.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'Görüntüdeki piksel sayısı çok fazla ({{ pixels }}). Beklenen maksimum miktar {{ max_pixels }}.',
    'This filename does not match the expected charset.' => 'Bu dosya adı beklenen karakter kümesiyle eşleşmiyor.',
    'This value is not valid XML.' => 'Bu değer geçerli bir XML değil.',
    'This value does not conform to the expected XSD schema.' => 'Bu değer beklenen XSD şemasına uymuyor.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Bu XML yükü çok büyük ({{ size }} bayt): {{ limit }} baytlık sınırı aşıyor.',
    'This value is not a valid cron expression.' => 'Bu değer geçerli bir cron ifadesi değil.',
    ...
    'Please enter a valid UUID.' => 'Lütfen geçerli bir UUID girin.',
  ),
  'security' => 
  array (
