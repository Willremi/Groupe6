...
$catalogue = new MessageCatalogue('ca', array (
  ...
  array (
    ...
    'This file is not a valid video.' => 'Aquest fitxer no és un vídeo vàlid.',
    'The size of the video could not be detected.' => 'No s\'ha pogut detectar la mida del vídeo.',
    'The video width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.' => 'L\'amplada del vídeo és massa gran ({{ width }}px). L\'amplada màxima permesa és {{ max_width }}px.',
    'The video width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.' => 'L\'amplada del vídeo és massa petita ({{ width }}px). L\'amplada mínima esperada és {{ min_width }}px.',
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'L\'altura del vídeo és massa gran ({{ height }}px). L\'altura màxima permesa és {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'L\'altura del vídeo és massa petita ({{ height }}px). L\'altura mínima esperada és {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'El vídeo no té suficients píxels ({{ pixels }}). La quantitat mínima esperada és {{ min_pixels }}.',
    'The video has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'El vídeo té massa píxels ({{ pixels }}). La quantitat màxima prevista és {{ max_pixels }}.',
    'The video ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.' => 'La relació del vídeo és massa gran ({{ ratio }}). La relació màxima permesa és {{ max_ratio }}.',
    'The video ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.' => 'La relació del vídeo és massa petita ({{ ratio }}). La relació mínima esperada és {{ min_ratio }}.',
    'The video is square ({{ width }}x{{ height }}px). Square videos are not allowed.' => 'El vídeo és quadrat ({{ width }}x{{ height }}px). No es permeten vídeos quadrats.',
    'The video is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented videos are not allowed.' => 'El vídeo té orientació horitzontal ({{ width }}x{{ height }} px). No es permeten vídeos horitzontals.',
    'The video is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented videos are not allowed.' => 'El vídeo és en orientació vertical ({{ width }}x{{ height }} px). No es permeten vídeos en orientació vertical.',
    'The video file is corrupted.' => 'El fitxer de vídeo està espatllat.',
    'The video contains multiple streams. Only one stream is allowed.' => 'El vídeo conté diversos fluxos. Només es permet un sol flux.',
    'Unsupported video codec "{{ codec }}".' => 'Còdec de vídeo incompatible «{{ codec }}».',
    'Unsupported video container "{{ container }}".' => 'Contenidor de vídeo incompatible "{{ container }}".',
    'The image file is corrupted.' => 'El fitxer d\'imatge està espatllat.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'La imatge no té suficients píxels ({{ pixels }}). La quantitat mínima esperada és {{ min_pixels }}.',
    'The image has too many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.' => 'La imatge té massa píxels ({{ pixels }}). El nombre màxim esperat és {{ max_pixels }}.',
    'This filename does not match the expected charset.' => 'Aquest nom de fitxer no coincideix amb el charset esperat.',
    'This value is not valid XML.' => 'Aquest valor no és un XML vàlid.',
    'This value does not conform to the expected XSD schema.' => 'Aquest valor no s\'ajusta a l\'esquema XSD esperat.',
    'This XML payload is too large ({{ size }} bytes): it exceeds the limit of {{ limit }} bytes.' => 'Aquesta càrrega XML és massa gran ({{ size }} bytes): supera el límit de {{ limit }} bytes.',
    'This value is not a valid cron expression.' => 'Aquest valor no és una expressió cron vàlida.',
    ...
    'Please enter a valid UUID.' => 'Introduïu un UUID vàlid.',
  ),
  'security' => 
  array (
