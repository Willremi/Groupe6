...
class __TwigTemplate_890809c4e33859012a5fe1797bd93d1b extends Template
{
...
class <?= \$class_name ?> implements UserProviderInterface, PasswordUpgraderInterface
{
     ...
     * or remember_me.
     *
     * If you\x27re not using these features, you do not need to implement
     * this method.
     *
    ...
    public function loadUserByIdentifier(\$identifier): UserInterface
    {
        ...
        throw new \\Exception(\x27TODO: fill in loadUserByIdentifier() inside \x27.__FILE__);
    }
     ...
     * called. Your job is to make sure the user\x27s data is still fresh by,
    ...
    public function refreshUser(UserInterface \$user): UserInterface
    {
        if (!\$user instanceof <?= \$user_short_name ?>) {
            throw new UnsupportedUserException(sprintf(\x27Invalid user class \"%s\".\x27, \$user::class));
        }

        // Return a User object after making sure its data is \"fresh\".
        // Or throw a UsernameNotFoundException if the user no longer exists.
        throw new \\Exception(\x27TODO: fill in refreshUser() inside \x27.__FILE__);
    }
...
", "@Maker/security/UserProvider.tpl.php", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\maker-bundle\\templates\\security\\UserProvider.tpl.php");
    }
}
