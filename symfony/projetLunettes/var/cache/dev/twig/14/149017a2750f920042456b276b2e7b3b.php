...
class __TwigTemplate_18e20127a6004a529f9ff3f07bf289be extends Template
{
...
<?php if (\$logout_setup): ?>
    ...
    <input type=\"<?= \$username_is_email ? \x27email\x27 : \x27text\x27; ?>\" value=\"";
        ...
        yield "\" name=\"<?= \$username_field; ?>\" id=\"input<?= ucfirst(\$username_field); ?>\" class=\"form-control\" autocomplete=\"<?= \$username_is_email ? \x27email\x27 : \x27username\x27; ?>\" required autofocus>
...
<?php endif; ?>
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"input<?= ucfirst(\$username_field); ?>\"><?= \$username_label; ?></label>
    <input type=\"<?= \$username_is_email ? \x27email\x27 : \x27text\x27; ?>\" value=\"{{ last_username }}\" name=\"<?= \$username_field; ?>\" id=\"input<?= ucfirst(\$username_field); ?>\" class=\"form-control\" autocomplete=\"<?= \$username_is_email ? \x27email\x27 : \x27username\x27; ?>\" required autofocus>
    <label for=\"inputPassword\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
...
{% endblock %}
", "@Maker/authenticator/login_form.tpl.php", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\maker-bundle\\templates\\authenticator\\login_form.tpl.php");
    }
}
