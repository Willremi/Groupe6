...
class __TwigTemplate_05a31b1b67adaacbafa02d70fb8dd4bb extends Template
{
...
<a href=\"{{ url(\x27app_reset_password\x27, {token: resetToken.token}) }}\">{{ url(\x27app_reset_password\x27, {token: resetToken.token}) }}</a>

<p>This link will expire in {{ resetToken.expirationMessageKey|trans(resetToken.expirationMessageData, \x27ResetPasswordBundle\x27) }}.</p>

<p>Cheers!</p>
", "@Maker/resetPassword/twig_email.tpl.php", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\maker-bundle\\templates\\resetPassword\\twig_email.tpl.php");
    }
}
