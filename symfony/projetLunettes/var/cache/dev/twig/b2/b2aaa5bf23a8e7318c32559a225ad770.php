...
class __TwigTemplate_c388555eb85fe6d47c75cffed713269f extends Template
{
...
class <?= \$class_name; ?> extends AbstractLoginFormAuthenticator
{
    ...
    public const LOGIN_ROUTE = \x27app_login\x27;
    ...
    {
        \$<?= \$username_field_var ?> = \$request->getPayload()->getString(\x27<?= \$username_field ?>\x27);

        \$request->getSession()->set(SecurityRequestAttributes::LAST_USERNAME, \$<?= \$username_field_var ?>);

        return new Passport(
            new UserBadge(\$<?= \$username_field_var ?>),
            new PasswordCredentials(\$request->getPayload()->getString(\x27password\x27)),
            [
                new CsrfTokenBadge(\x27authenticate\x27, \$request->getPayload()->getString(\x27_csrf_token\x27)),<?= \$remember_me_badge ? \"
                new RememberMeBadge(),\\n\" : \"\" ?>
            ]
        );
    }
    ...
    public function onAuthenticationSuccess(Request \$request, TokenInterface \$token, string \$firewallName): ?Response
    {
        ...
        // For example:
        // return new RedirectResponse(\$this->urlGenerator->generate(\x27some_route\x27));
        throw new \\Exception(\x27TODO: provide a valid redirect inside \x27.__FILE__);
    }
...
", "@Maker/authenticator/LoginFormAuthenticator.tpl.php", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\maker-bundle\\templates\\authenticator\\LoginFormAuthenticator.tpl.php");
    }
}
