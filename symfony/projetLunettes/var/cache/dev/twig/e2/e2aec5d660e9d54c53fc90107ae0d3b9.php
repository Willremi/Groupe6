...
class __TwigTemplate_cd68e91714c3dce3fb2a8f02df3b594a extends Template
{
    ...
    <ul class=\"pagination\">
        ...
        {% else %}
            <li class=\"arrow unavailable\">
                <a>
                    &laquo; {{ \x27label_previous\x27|trans({}, \x27KnpPaginatorBundle\x27) }}
                </a>
            </li>
        {% endif %}
        ...
        {% if next is defined %}
            <li class=\"arrow\">
                <a rel=\"next\" href=\"{{ path(route, knp_pagination_query(query, next, options)) }}\">
                    {{ \x27label_next\x27|trans({}, \x27KnpPaginatorBundle\x27) }} &nbsp;&raquo;
                </a>
            </li>
        {% else %}
            <li class=\"arrow unavailable\">
