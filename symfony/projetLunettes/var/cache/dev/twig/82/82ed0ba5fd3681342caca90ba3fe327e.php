...
class __TwigTemplate_7c888a7847c59a0053119a9e961e46ae extends Template
{
...
#[AsSchedule<?php if (\$has_transport_name): ?>(\x27<?= \$transport_name; ?>\x27)<?php endif ?>]
...
<?php if (\$has_custom_message): ?>
            ...
            RecurringMessage::every(\x271 hour\x27, new <?= \$message_class_name; ?>()),
<?php else: ?>
            // @TODO - Create a Message to schedule
            // RecurringMessage::every(\x271 hour\x27, new App\\Message\\Message()),
<?php endif ?>
            )
            ->stateful(\$this->cache)
        ;
...
", "@Maker/scheduler/Schedule.tpl.php", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\maker-bundle\\templates\\scheduler\\Schedule.tpl.php");
    }
}
