...
class __TwigTemplate_6e11ee9d3cf3fb28ca41cdb0f6e9094e extends Template
{
        ...
        class SymfonyProfilerFormPanel {
            ...
            #initTrees() {
                ...
                treeItems.forEach((treeItem) => {
                    var targetId = treeItem.getAttribute(\x27data-tab-target-id\x27);
...
{% block menu %}
    <span class=\"label label-status-{{ collector.data.nb_errors ? \x27error\x27 }} {{ collector.data.forms is empty ? \x27disabled\x27 }}\">
        <span class=\"icon\">{{ source(\x27@WebProfiler/Icon/form.svg\x27) }}</span>
        <strong>Forms</strong>
