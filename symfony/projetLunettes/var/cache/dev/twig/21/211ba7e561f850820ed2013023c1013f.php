...
class __TwigTemplate_7f290dbb44349b8d247644b6a286bd46 extends Template
{
...
{% if pageCount > 1 %}
    <ul class=\"uk-pagination uk-flex-center uk-margin-medium-top\">
        {% if previous is defined %}
            <li>
                <a rel=\"prev\" href=\"{{ path(route, knp_pagination_query(query, previous, options)) }}\">&laquo;&nbsp;{{ \x27label_previous\x27|trans({}, \x27KnpPaginatorBundle\x27) }}</a>
            </li>
        {% else %}
            <li class=\"uk-disabled\">
                <span>&laquo;&nbsp;{{ \x27label_previous\x27|trans({}, \x27KnpPaginatorBundle\x27) }}</span>
            </li>
        {% endif %}
        ...
        {% if next is defined %}
            <li>
                <a rel=\"next\" href=\"{{ path(route, knp_pagination_query(query, next, options)) }}\">{{ \x27label_next\x27|trans({}, \x27KnpPaginatorBundle\x27) }}&nbsp;&raquo;</a>
            </li>
        {% else %}
            <li class=\"uk-disabled\">
                <span>{{ \x27label_next\x27|trans({}, \x27KnpPaginatorBundle\x27) }}&nbsp;&raquo;</span>
            </li>
        {% endif %}
    </ul>
{% endif %}
