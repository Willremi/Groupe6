...
class __TwigTemplate_8bb1a4a7564eb0d12e8f26d32453d2a4 extends Template
{
...
(function() {
    ...
    [...configOptions].forEach(option => {
        option.addEventListener(\x27change\x27, function (event) {
            ...
            const resolvedSettingValue = \x27theme-auto\x27 === settingValue
                ? (matchMedia(\x27(prefers-color-scheme: dark)\x27).matches ? \x27theme-dark\x27 : \x27theme-light\x27)
                : settingValue;
            document.body.classList.add(resolvedSettingValue);

            if (resolvedSettingValue.startsWith(\x27theme-\x27)) {
                document.body.style.colorScheme = resolvedSettingValue.endsWith(\x27-light\x27) ? \x27light\x27 : \x27dark\x27;
            }
        });
    });
    ...
    closeModalButton.addEventListener(\x27click\x27, closeModal);
    modalWrapper.addEventListener(\x27click\x27, function(event) {
        if (event.target == event.currentTarget) {
            closeModal();
        }
    });
    modalWrapper.addEventListener(\x27keydown\x27, function(event) {
        if (event.key === \x27Esc\x27 || event.key === \x27Escape\x27) {
            closeModal();
        }
    });
})();
...
<a href=\"#\" id=\"open-settings\">
    <span class=\"icon\">{{ source(\x27@WebProfiler/Icon/settings.svg\x27) }}</span>
    Profiler settings
</a>
        ...
        <div class=\"modal-content\">
            ...
            <div class=\"settings-group\">
                <label for=\"settings-theme-auto\">
                    <input class=\"config-option\" type=\"radio\" name=\"theme\" value=\"auto\" id=\"settings-theme-auto\">
                    <p>
                        {{ source(\x27@WebProfiler/Icon/settings-theme-system.svg\x27) }}
                        <span>System / OS</span>
                    </p>
                </label>
                ...
                <label for=\"settings-theme-light\">
                    <input class=\"config-option\" type=\"radio\" name=\"theme\" value=\"light\" id=\"settings-theme-light\">
                    <p>
                        {{ source(\x27@WebProfiler/Icon/settings-theme-light.svg\x27) }}
                        <span>Light</span>
                    </p>
                </label>
                ...
                <label for=\"settings-theme-dark\">
                    <input class=\"config-option\" type=\"radio\" name=\"theme\" value=\"dark\" id=\"settings-theme-dark\">
                    <p>
                        {{ source(\x27@WebProfiler/Icon/settings-theme-dark.svg\x27) }}
                        <span>Dark</span>
                    </p>
                </label>
            </div>
            ...
            <div class=\"settings-group\">
                <label for=\"settings-width-normal\">
                    <input class=\"config-option\" type=\"radio\" name=\"width\" value=\"normal\" id=\"settings-width-normal\">
                    <p>
                        {{ source(\x27@WebProfiler/Icon/settings-width-fixed.svg\x27) }}
                        <span>Fixed width</span>
                    </p>
                </label>
                ...
                <label for=\"settings-width-full\">
                    <input class=\"config-option\" type=\"radio\" name=\"width\" value=\"full\" id=\"settings-width-full\">
                    <p>
                        {{ source(\x27@WebProfiler/Icon/settings-width-fitted.svg\x27) }}
                        <span>Fit to window</span>
                    </p>
                </label>
            </div>
...
", "@WebProfiler/Profiler/settings.html.twig", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\settings.html.twig");
    }
}
