...
class __TwigTemplate_820d80eb6d447f260c8f07260ec2a82b extends Template
{
...
{% block menu %}
<span class=\"label\">
    <span class=\"icon\">{{ source(\x27@WebProfiler/Icon/event.svg\x27) }}</span>
    <strong>Events</strong>
</span>
{% endblock %}
    ...
    <div class=\"sf-tabs\">
        {% for dispatcherName, dispatcherData in collector.data %}
            <div class=\"tab\">
                ...
                <div class=\"tab-content\">
                    {% if dispatcherData[\x27called_listeners\x27] is empty %}
                    ...
                    {% else %}
                        <div class=\"sf-tabs\">
                            <div class=\"tab\">
                                <h3 class=\"tab-title\">Called Listeners <span class=\"badge\">{{ dispatcherData[\x27called_listeners\x27]|length }}</span></h3>

                                <div class=\"tab-content\">
                                    {{ _self.render_table(dispatcherData[\x27called_listeners\x27]) }}
                                </div>
                            </div>

                            <div class=\"tab\">
                                <h3 class=\"tab-title\">Not Called Listeners <span class=\"badge\">{{ dispatcherData[\x27not_called_listeners\x27]|length }}</span></h3>
                                <div class=\"tab-content\">
                                    {% if dispatcherData[\x27not_called_listeners\x27] is empty %}
                                        <div class=\"empty\">
                                            <p>
                                                <strong>There are no uncalled listeners</strong>.
                                            </p>
                                    ...
                                    {% else %}
                                        {{ _self.render_table(dispatcherData[\x27not_called_listeners\x27]) }}
                                    {% endif %}
                                </div>
                            </div>

                            <div class=\"tab\">
                                <h3 class=\"tab-title\">Orphaned Events <span class=\"badge\">{{ dispatcherData[\x27orphaned_events\x27]|length }}</span></h3>
                                <div class=\"tab-content\">
                                    {% if dispatcherData[\x27orphaned_events\x27] is empty %}
                                        <div class=\"empty\">
                                            <p>
                                                <strong>There are no orphaned events</strong>.
                                            </p>
                                    ...
                                    {% else %}
                                        <table>
                                            ...
                                            <tbody>
                                                {% for event in dispatcherData[\x27orphaned_events\x27] %}
                                                    <tr>
...
{% macro render_table(listeners) %}
    <table>
        ...
        {% for listener in listeners %}
            ...
            <tr>
                <td class=\"text-right nowrap\">{{ listener.priority|default(\x27-\x27) }}</td>
...
{% endmacro %}
", "@WebProfiler/Collector/events.html.twig", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\events.html.twig");
    }
}
