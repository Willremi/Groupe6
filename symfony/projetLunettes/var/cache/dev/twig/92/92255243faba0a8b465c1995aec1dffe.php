...
class __TwigTemplate_b751400669f52eb83784e71625111cb4 extends Template
{
...
<?php if (\$should_escape_table_name): ?>#[ORM\\Table(name: \x27`<?= \$table_name ?>`\x27)]
<?php endif ?>
<?php if (\$api_resource): ?>
#[ApiResource]
<?php endif ?>
...
<?php if (EntityIdTypeEnum::UUID === \$id_type): ?>
    ...
    #[ORM\\GeneratedValue(strategy: \x27CUSTOM\x27)]
    #[ORM\\CustomIdGenerator(class: \x27doctrine.uuid_generator\x27)]
...
<?php elseif (EntityIdTypeEnum::ULID === \$id_type): ?>
    ...
    #[ORM\\GeneratedValue(strategy: \x27CUSTOM\x27)]
    #[ORM\\CustomIdGenerator(class: \x27doctrine.ulid_generator\x27)]
...
", "@Maker/doctrine/Entity.tpl.php", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\maker-bundle\\templates\\doctrine\\Entity.tpl.php");
    }
}
