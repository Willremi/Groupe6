...
class __TwigTemplate_96f085e00ce698b3dabfb66236bd91b4 extends Template
{
...
";
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            // line 59
            yield "            ";
            $context["cache_pools_with_calls"] = Twig\Extension\CoreExtension::merge(Twig\Extension\CoreExtension::filter($this->env, $this->env->hasExtension(\Twig\Extension\SandboxExtension::class) && $this->env->getExtension(\Twig\Extension\SandboxExtension::class)->isSandboxed($this->source), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 59, $this->source); })()), "calls", [], "any", false, false, false, 59), function ($__calls__) use ($context, $macros) { $context["calls"] = $__calls__; return (Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["calls"]) || array_key_exists("calls", $context) ? $context["calls"] : (function () { throw new RuntimeError('Variable "calls" does not exist.', 59, $this->source); })())) > 0); }), []);
            // line 60
            yield "            ";
            ...
            foreach ($context['_seq'] as $context["name"] => $context["calls"]) {
                ...
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 106)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    ...
                    // line 118
                    $context['_parent'] = $context;
                    $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::sort($this->env, $this->env->hasExtension(\Twig\Extension\SandboxExtension::class) && $this->env->getExtension(\Twig\Extension\SandboxExtension::class)->isSandboxed($this->source), Twig\Extension\CoreExtension::keys(Twig\Extension\CoreExtension::filter($this->env, $this->env->hasExtension(\Twig\Extension\SandboxExtension::class) && $this->env->getExtension(\Twig\Extension\SandboxExtension::class)->isSandboxed($this->source), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 118, $this->source); })()), "calls", [], "any", false, false, false, 118), function ($__calls__) use ($context, $macros) { $context["calls"] = $__calls__; return (0 == Twig\Extension\CoreExtension::length($this->env->getCharset(), $context["calls"])); }))));
...
{% block toolbar %}
    {% if collector.totals.calls > 0 %}
        {% set icon %}
            {{ source(\x27@WebProfiler/Icon/cache.svg\x27) }}
            <span class=\"sf-toolbar-value\">{{ collector.totals.calls }}</span>
            <span class=\"sf-toolbar-info-piece-additional-detail\">
                <span class=\"sf-toolbar-label\">in</span>
                <span class=\"sf-toolbar-value\">{{ \x27%0.2f\x27|format(collector.totals.time * 1000) }}</span>
                <span class=\"sf-toolbar-label\">ms</span>
            </span>
        {% endset %}
        {% set text %}
        ...
        <div class=\"sf-toolbar-info-piece\">
            <b>Total time</b>
            <span>{{ \x27%0.2f\x27|format(collector.totals.time * 1000) }} ms</span>
        </div>
        <div class=\"sf-toolbar-info-piece\">
            <b>Cache hits</b>
...
{% block menu %}
    <span class=\"label {{ collector.totals.calls == 0 ? \x27disabled\x27 }}\">
        <span class=\"icon\">
            {{ source(\x27@WebProfiler/Icon/cache.svg\x27) }}
        </span>
        <strong>Cache</strong>
    ...
    {% else %}
        ...
        <div class=\"sf-tabs\">
            ...
            {% for name, calls in cache_pools_with_calls %}
                <div class=\"tab {{ calls|length == 0 ? \x27disabled\x27 }}\">
                            ...
                            <table>
                                ...
                                {% for call in calls %}
                                    <tr>
                                        ...
                                        <td class=\"nowrap\">{{ \x27%0.2f\x27|format((call.end - call.start) * 1000) }} ms</td>
...
{% macro render_metrics(pool, is_total = false) %}
    <div class=\"metrics\">
        <div class=\"metric\">
            ...
            <span class=\"label\">{{ is_total ? \x27Total calls\x27 : \x27Calls\x27 }}</span>
        </div>
        <div class=\"metric\">
            <span class=\"value\">{{ \x27%0.2f\x27|format(pool.time * 1000) }} <span class=\"unit\">ms</span></span>
            <span class=\"label\">{{ is_total ? \x27Total time\x27 : \x27Time\x27 }}</span>
        </div>
        ...
        <div class=\"metric-group\">
            <div class=\"metric\">
                ...
                <span class=\"label\">{{ is_total ? \x27Total reads\x27 : \x27Reads\x27 }}</span>
            </div>
            <div class=\"metric\">
                <span class=\"value\">{{ pool.writes }}</span>
                <span class=\"label\">{{ is_total ? \x27Total writes\x27 : \x27Writes\x27 }}</span>
            </div>
            <div class=\"metric\">
                <span class=\"value\">{{ pool.deletes }}</span>
                <span class=\"label\">{{ is_total ? \x27Total deletes\x27 : \x27Deletes\x27 }}</span>
            </div>
        </div>
        ...
        <div class=\"metric-group\">
            <div class=\"metric\">
                ...
                <span class=\"label\">{{ is_total ? \x27Total hits\x27 : \x27Hits\x27 }}</span>
            </div>
            <div class=\"metric\">
                <span class=\"value\">{{ pool.misses }}</span>
                <span class=\"label\">{{ is_total ? \x27Total misses\x27 : \x27Misses\x27 }}</span>
            </div>
            <div class=\"metric\">
                    <span class=\"value\">
...
{% endmacro %}
", "@WebProfiler/Collector/cache.html.twig", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\cache.html.twig");
    }
}
