...
class __TwigTemplate_eba73e86623befe15c1a08cf4398f597 extends Template
{
...
{% block menu %}
    <span class=\"label {{ collector.hasexception ? \x27label-status-error\x27 : \x27disabled\x27 }}\">
        <span class=\"icon\">{{ source(\x27@WebProfiler/Icon/exception.svg\x27) }}</span>
        <strong>Exception</strong>
        {% if collector.hasexception %}
            <span class=\"count\">
                <span>1</span>
...
{% block panel %}
    {# these styles are needed to override some styles from Exception page, which wasn\x27t
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/exception.html.twig", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\exception.html.twig");
    }
}
