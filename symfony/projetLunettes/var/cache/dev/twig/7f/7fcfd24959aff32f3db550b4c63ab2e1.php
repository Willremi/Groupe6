...
class __TwigTemplate_d85af0c1bd2e0eb0371ad8a70279f998 extends Template
{
    ...
    <div class=\"metrics\">
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 100, $this->source); })()), "children", [], "any", false, false, false, 100)) > 0)) {
            ...
            yield "</span>
                ...
                ";
            // line 109
            $context["subrequests_time"] = (((($tmp = (isset($context["has_time_events"]) || array_key_exists("has_time_events", $context) ? $context["has_time_events"] : (function () { throw new RuntimeError('Variable "has_time_events" does not exist.', 109, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::reduce($this->env, $this->env->hasExtension(\Twig\Extension\SandboxExtension::class) && $this->env->getExtension(\Twig\Extension\SandboxExtension::class)->isSandboxed($this->source), CoreExtension::getAttribute($this->env, $this->source,             // line 110
...
{% block toolbar %}
    ...
    {% set icon %}
        {{ source(\x27@WebProfiler/Icon/time.svg\x27) }}
...
{% block menu %}
    <span class=\"label\">
        <span class=\"icon\">{{ source(\x27@WebProfiler/Icon/time.svg\x27) }}</span>
        <strong>Performance</strong>
    </span>
{% endblock %}
        ...
        {% if profile.children|length > 0 %}
            ...
            <div class=\"metric-group\">
                <div class=\"metric\">
                    ...
                    <span class=\"label\">Sub-{{ profile_type|title }}{{ profile.children|length > 1 ? \x27s\x27 }}</span>
                </div>

                {% set subrequests_time = has_time_events
                    ? profile.children|reduce((total, child) => total + child.getcollector(\x27time\x27).events.__section__.duration, 0)
                    : \x27n/a\x27 %}

                <div class=\"metric\">
                    <span class=\"value\">{{ subrequests_time }} <span class=\"unit\">ms</span></span>
                    <span class=\"label\">Sub-{{ profile_type|title }}{{ profile.children|length > 1 ? \x27s\x27 }} time</span>
                </div>
            </div>
        {% endif %}
    </div>
...
{% block panelContent %}
    ...
    {% if profile.parent %}
        <h3 class=\"dump-inline\">
            Sub-{{ profile_type|title }} {{ profiler_dump(profile.getcollector(\x27request\x27).requestattributes.get(\x27_controller\x27)) }}
            <small>
                {{ collector.events.__section__.duration }} ms
                <a class=\"newline\" href=\"{{ path(\x27_profiler\x27, { token: profile.parent.token, panel: \x27time\x27 }) }}\">Return to parent {{ profile_type }}</a>
            </small>
        </h3>
...
<script>
{{ source(\x27@WebProfiler/Collector/time.js\x27) }}
</script>
{% endblock %}
