...
class __TwigTemplate_d747d10722877481c1062bfe89054774 extends Template
{
...
{% block toolbar %}
    ...
    {% set icon %}
        {{ source(\x27@WebProfiler/Icon/twig.svg\x27) }}
...
{% block menu %}
    <span class=\"label {{ 0 == collector.templateCount ? \x27disabled\x27 }}\">
        <span class=\"icon\">{{ source(\x27@WebProfiler/Icon/twig.svg\x27) }}</span>
        <strong>Twig</strong>
    </span>
{% endblock %}
