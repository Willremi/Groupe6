...
class __TwigTemplate_8c713149616ffad03da215fb80da6858 extends Template
{
...
{% block toolbar %}
    {% if collector.violationsCount > 0 or collector.calls|length %}
        ...
        {% set icon %}
            {{ source(\x27@WebProfiler/Icon/validator.svg\x27) }}
            <span class=\"sf-toolbar-value\">
...
{% block menu %}
    <span class=\"label {{- collector.violationsCount ? \x27 label-status-error\x27 }} {{ collector.calls is empty ? \x27disabled\x27 }}\">
        <span class=\"icon\">{{ source(\x27@WebProfiler/Icon/validator.svg\x27) }}</span>
        <strong>Validator</strong>
