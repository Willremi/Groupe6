...
class __TwigTemplate_f507d2d974441314469cf4c46c68ba32 extends Template
{
...
{%- block checkbox_widget -%}
    {%- set attr_class = attr_class|default(attr.class|default(\x27\x27)) -%}
    {%- set row_class = \x27\x27 -%}
    {%- if \x27btn-check\x27 not in attr_class -%}
        {%- set attr_class = attr_class ~ \x27 form-check-input\x27 -%}
...
{%- block checkbox_radio_label -%}
    ...
    {%- if widget is defined -%}
        {%- set label_attr_class = label_attr_class|default(label_attr.class|default(\x27\x27)) -%}
        {%- if \x27btn\x27 not in label_attr_class -%}
            {%- set label_attr_class = label_attr_class ~ \x27 form-check-label\x27 -%}
        {%- endif -%}
...
{%- block form_help -%}
    ...
    {{- parent() -}}
{%- endblock form_help %}
", "bootstrap_5_layout.html.twig", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\twig-bridge\\Resources\\views\\Form\\bootstrap_5_layout.html.twig");
    }
}
