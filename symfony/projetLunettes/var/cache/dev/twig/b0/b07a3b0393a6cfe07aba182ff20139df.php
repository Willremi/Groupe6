...
class __TwigTemplate_5aff094df4d121d02097120b3f88302e extends Template
{
...
{% block percent_widget -%}
    {%- if symbol -%}
        <div class=\"input-group\">
            {{- block(\x27form_widget_simple\x27) -}}
            <span class=\"input-group-addon\">{{ symbol|default(\x27%\x27) }}</span>
        </div>
    {%- else -%}
        {{- block(\x27form_widget_simple\x27) -}}
    {%- endif -%}
    ...
    {%- else -%}
        ...
        <div {{ block(\x27widget_container_attributes\x27) }}>
            ...
            <div class=\"table-responsive\">
                <table class=\"table {{ table_class|default(\x27table-bordered table-condensed table-striped\x27) }}\" role=\"presentation\">
                    <thead>
                    <tr>
...
{% block choice_label -%}
    ...
    {%- set label_attr = label_attr|merge({class: label_attr.class|default(\x27\x27)|replace({\x27checkbox-inline\x27: \x27\x27, \x27radio-inline\x27: \x27\x27, \x27checkbox-custom\x27: \x27\x27, \x27radio-custom\x27: \x27\x27, \x27switch-custom\x27: \x27\x27})|trim}) -%}
