...
class __TwigTemplate_9ee19a6506ce4d6fd3e0aa95c27a612d extends Template
{
...
{% set css_class = status_code == 113 or interrupted is not null ? \x27status-warning\x27 : status_code > 0 ? \x27status-error\x27 : \x27status-success\x27 %}
...
<div class=\"terminal status {{ css_class }}\">
    <div class=\"container\">
        ...
        <dl class=\"metadata\">
            ...
            {% if request_collector.requestserver.has(\x27SYMFONY_CLI_BINARY_NAME\x27) %}
                <dt>Symfony CLI</dt>
                <dd>v{{ request_collector.requestserver.get(\x27SYMFONY_CLI_VERSION\x27) }}</dd>
            {% endif %}

            <dt>Application</dt>
            <dd>
                <a href=\"{{ path(\x27_profiler_search_results\x27, { token: token, limit: 10, ip: profile.ip, type: \x27command\x27 }) }}\">{{ profile.ip }}</a>
            </dd>
...
", "@WebProfiler/Profiler/_command_summary.html.twig", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\_command_summary.html.twig");
    }
}
