...
class __TwigTemplate_4e6e2b9e4547d9fed5c4267923462b6e extends Template
{
...

{
    public function validate(mixed \$value, Constraint \$constraint): void
    {
        ...
        \$this->context->buildViolation(\$constraint->message)
            ->setParameter(\x27";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["value"]) || array_key_exists("value", $context) ? $context["value"] : (function () { throw new RuntimeError('Variable "value" does not exist.', 20, $this->source); })()), "html", null, true);
        yield "\x27, \$value)
            ->addViolation()
        ;
    }
...

{
    public function validate(mixed \$value, Constraint \$constraint): void
    {
        ...
        // TODO: implement the validation here
        \$this->context->buildViolation(\$constraint->message)
            ->setParameter(\x27{{ value }}\x27, \$value)
            ->addViolation()
        ;
    }
}
", "@Maker/validator/Validator.tpl.php", "D:\\Github\\Groupe6\\symfony\\projetLunettes\\vendor\\symfony\\maker-bundle\\templates\\validator\\Validator.tpl.php");
    }
}
