...
class __TwigTemplate_8f3d172141ef84252604bc04f61e0460 extends Template
{
            ...
            {% if next is defined %}
                <li class=\"pagination-next\">
                    <a rel=\"next\" href=\"{{ path(route, knp_pagination_query(query, next, options)) }}\">
                        {{ \x27label_next\x27|trans({}, \x27KnpPaginatorBundle\x27) }}
                    </a>
                </li>
            {% else %}
