...
class __TwigTemplate_ce06a65d5871aa3c01d988d7d02527b2 extends Template
{
...
";
    ...
    <div class=\"bg-light p-3\">
        ...
        ";
            ...
            // line 49
            yield "            <p>Surprise, c\x27est vide !</p>
        ";
        }
        // line 51
        yield "    </div>
               ...
               <tbody>
                {% for item in items %}
                    <tr>
                        ...
                        <td>
                            <a href=\"{{ path(\x27cart_remove\x27, {\x27id\x27: item.lunettes.id}) }}\" class=\"btn btn-danger btn-sm\">
                               <i class=\"fa fa-trash\"></i> 
                            </a>
                        </td>
                    </tr>
