 ...
 */
class getCouleurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CouleurRepository' shared autowired service.
     *
     * @return \App\Repository\CouleurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CouleurRepository.php';

        return $container->privates['App\\Repository\\CouleurRepository'] = new \App\Repository\CouleurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
