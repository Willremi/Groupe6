 ...
 */
class getLunettesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LunettesRepository' shared autowired service.
     *
     * @return \App\Repository\LunettesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LunettesRepository.php';

        return $container->privates['App\\Repository\\LunettesRepository'] = new \App\Repository\LunettesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
