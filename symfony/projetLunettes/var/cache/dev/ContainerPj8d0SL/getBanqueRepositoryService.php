 ...
 */
class getBanqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BanqueRepository.php';

        return $container->privates['App\\Repository\\BanqueRepository'] = new \App\Repository\BanqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
