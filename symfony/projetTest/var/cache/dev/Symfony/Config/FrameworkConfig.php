...
class FrameworkConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
    ...
    /**
     * form configuration
     * @default {"enabled":true,"csrf_protection":{"enabled":null,"field_name":"_token"},"legacy_error_messages":true}
    */
    ...
    */
     ...
     * @default {"enabled":false,"collect":true,"collect_parameter":null,"only_exceptions":false,"only_main_requests":false,"only_master_requests":false,"dsn":"file:%kernel.cache_dir%\/profiler"}
    */
     ...
     * @default {"enabled":false,"default_uri":null,"http_port":80,"https_port":443,"strict_requirements":true,"utf8":null}
    */
     ...
     * @default {"enabled":false,"storage_id":"session.storage.native","storage_factory_id":null,"handler_id":"session.handler.native_file","cookie_httponly":true,"cookie_samesite":null,"gc_probability":1,"save_path":"%kernel.cache_dir%\/sessions","metadata_update_threshold":0}
    ...
    */
     ...
     * @default {"enabled":true,"fallbacks":[],"logging":false,"formatter":"translator.formatter.default","cache_dir":"%kernel.cache_dir%\/translations","default_path":"%kernel.project_dir%\/translations","paths":[],"enabled_locales":[],"pseudo_localization":{"enabled":false,"accents":true,"expansion_factor":1,"brackets":true,"parse_html":false,"localizable_html_attributes":[]},"providers":[]}
    */
    ...
    */
     ...
     * @default {"enabled":false,"routing":[],"serializer":{"default_serializer":"messenger.transport.native_php_serializer","symfony_serializer":{"format":"json","context":[]}},"transports":[],"failure_transport":null,"reset_on_message":null,"default_bus":null,"buses":{"messenger.bus.default":{"default_middleware":true,"middleware":[]}}}
    */
