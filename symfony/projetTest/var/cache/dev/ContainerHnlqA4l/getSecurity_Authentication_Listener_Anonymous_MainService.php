...
class getSecurity_Authentication_Listener_Anonymous_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authentication.listener.anonymous.main'])) {
            return $container->privates['security.authentication.listener.anonymous.main'];
        }

        $instance = new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), $container->getParameter('container.build_hash'), ($container->privates['monolog.logger.security'] ?? $container->load('getMonolog_Logger_SecurityService')), $a);

        if (isset($container->privates['security.authentication.listener.anonymous.main'])) {
            return $container->privates['security.authentication.listener.anonymous.main'];
        }

        return $container->privates['security.authentication.listener.anonymous.main'] = $instance;
    }
}
