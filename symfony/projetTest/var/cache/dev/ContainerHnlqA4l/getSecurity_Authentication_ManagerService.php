...
class getSecurity_Authentication_ManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () use ($container) {
        ...
        if (isset($container->privates['security.authentication.manager'])) {
            return $container->privates['security.authentication.manager'];
        }

        $container->privates['security.authentication.manager'] = $instance;
