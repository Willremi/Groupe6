...
class getSecurity_Authentication_GuardHandlerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Guard\GuardAuthenticatorHandler(($container->services['.container.private.security.token_storage'] ?? self::get_Container_Private_Security_TokenStorageService($container)), $a, []);

        if (isset($container->privates['security.authentication.guard_handler'])) {
            return $container->privates['security.authentication.guard_handler'];
        }

        $container->privates['security.authentication.guard_handler'] = $instance;
