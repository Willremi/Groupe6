 ...
 */
class getTypeVehiculeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeVehiculeRepository' shared autowired service.
     *
     * @return \App\Repository\TypeVehiculeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeVehiculeRepository.php';

        return $container->privates['App\\Repository\\TypeVehiculeRepository'] = new \App\Repository\TypeVehiculeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
