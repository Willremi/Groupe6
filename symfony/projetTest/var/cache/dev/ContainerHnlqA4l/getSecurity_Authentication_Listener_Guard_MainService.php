...
class getSecurity_Authentication_Listener_Guard_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, $b, 'main', new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Security\\RegistrationAuthenticator'] ?? $container->load('getRegistrationAuthenticatorService'));
        }, 1), ($container->privates['monolog.logger.security'] ?? $container->load('getMonolog_Logger_SecurityService')), true, ($container->services['.container.private.security.token_storage'] ?? self::get_Container_Private_Security_TokenStorageService($container)));

        if (isset($container->privates['security.authentication.listener.guard.main'])) {
            return $container->privates['security.authentication.listener.guard.main'];
        }

        return $container->privates['security.authentication.listener.guard.main'] = $instance;
    }
}
