...
class getSecurity_Authentication_Listener_Form_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $e = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, [], ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')));
        ...
        $instance = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener(($container->services['.container.private.security.token_storage'] ?? self::get_Container_Private_Security_TokenStorageService($container)), $a, ($container->privates['security.authentication.session_strategy'] ?? $container->load('getSecurity_Authentication_SessionStrategyService')), $d, 'main', $e, $g, ['login_path' => 'login', 'check_path' => 'login', 'use_forward' => false, 'require_previous_session' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'enable_csrf' => false, 'post_only' => true, 'form_only' => false], $f, $c, NULL);

        if (isset($container->privates['security.authentication.listener.form.main'])) {
            return $container->privates['security.authentication.listener.form.main'];
        }

        return $container->privates['security.authentication.listener.form.main'] = $instance;
    }
}
