...
class getVehiculeControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.vrLC47k'] ?? $container->load('get_ServiceLocator_VrLC47kService'))->withContext('App\\Controller\\VehiculeController', $container));
