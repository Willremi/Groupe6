...
/* base.html.twig */
class __TwigTemplate_7b93c0c72075024055d695ad12b26efd extends Template
{
...
<html>
    <head>
        ...
        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, minimum-scale=1\">
        <link rel=\"shortcut icon\" href=\"{{ asset(\x27assets/images/logo.png\x27) }}\" type=\"image/x-icon\">
        <meta name=\"description\" content=\"\">
        <title>{% block title %}Welcome!{% endblock %}</title>
        <link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css\" integrity=\"sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk\" crossorigin=\"anonymous\">

        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/web/assets/mobirise-icons/mobirise-icons.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/tether/tether.min.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/bootstrap/css/bootstrap.min.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/bootstrap/css/bootstrap-grid.min.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/bootstrap/css/bootstrap-reboot.min.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/dropdown/css/style.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/socicon/css/styles.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/theme/css/style.css\x27) }}\">
        <link rel=\"preload\" as=\"style\" href=\"{{ asset(\x27assets/mobirise/css/mbr-additional.css\x27) }}\">
        <link rel=\"stylesheet\" href=\"{{ asset(\x27assets/mobirise/css/mbr-additional.css\x27) }}\" type=\"text/css\">
    ...
    <body>
                ...
                <nav class=\"navbar navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent\">
                    ...
                    <div class=\"menu-bottom\">
                        <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
                            <ul class=\"navbar-nav nav-dropdown js-float-line nav-right\" data-app-modern-menu=\"true\">
                                <li class=\"nav-item\">
                                    <a class=\"nav-link link mbr-black text-danger display-4\" href=\"{{ path(\x27home\x27) }}\">
                                        Accueil</a>
                                </li>
                                <li class=\"nav-item dropdown\">
                                    <a class=\"nav-link link mbr-black dropdown-toggle text-danger display-4\" href=\"#\" data-toggle=\"dropdown-submenu\" aria-expanded=\"false\">Véhicules</a>
                                    <div class=\"dropdown-menu\">
                                        <a class=\"dropdown-item\" href=\"{{ path(\x27vehicule_index\x27) }}\">Liste des véhicules</a>
                                        <div class=\"dropdown-divider\"></div>
                                        <a class=\"dropdown-item\" href=\"{{ path(\x27marque_index\x27) }}\">Liste des marques</a>
                                        <div class=\"dropdown-divider\"></div>
                                        <a class=\"dropdown-item\" href=\"{{ path(\x27color_index\x27) }}\">Liste des couleurs</a>
                                        <div class=\"dropdown-divider\"></div>
                                        <a class=\"dropdown-item\" href=\"{{ path(\x27type_vehicule_index\x27) }}\">Liste des types</a>
                                        <div class=\"dropdown-divider\"></div>
                                        <a class=\"dropdown-item\" href=\"{{ path(\x27options_index\x27) }}\">Liste des options</a>

                                        <div class=\"dropdown-divider\"></div>
                                        <a class=\"dropdown-item\" href=\"{{ path(\x27energy_index\x27) }}\">Liste des carburants</a>
                                    </div>
                                </li>
                                <li class=\"nav-item\">
                                    <a class=\"nav-link link mbr-black text-danger display-4\" href=\"{{ path(\x27contact\x27) }}\">
                                        Contact</a>
                                </li>
        ...
        {% endblock %}
                        ...
                        <div class=\"row\">
                            ...
                            <div class=\"col-lg-4 col-md-12 col-sm-12\">
                                ...
                                <div class=\"navbar-brand\">
                                    <div class=\"logo\">
                                        <a href=\"#\">
                                            <img class=\"navbar-logo\" src=\"{{ asset(\x27assets/images/mbr-160x160.png\x27) }}\" alt=\"\" title=\"\">
                                        </a>
                                    </div>
                            ...
                            <div class=\"col-lg-4 col-md-12 col-sm-12 img-list\">
                                ...
                                <img class=\"tipsfooter\" src=\"{{ asset(\x27assets/images/mbr-180x120.jpg\x27) }}\" alt=\"\" title=\"\">
            ...
            <script src=\"{{ asset(\x27assets/web/assets/jquery/jquery.min.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/popper/popper.min.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/tether/tether.min.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/bootstrap/js/bootstrap.min.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/smoothscroll/smooth-scroll.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/dropdown/js/nav-dropdown.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/dropdown/js/navbar-dropdown.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/touchswipe/jquery.touch-swipe.min.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/theme/js/script.js\x27) }}\"></script>
            <script src=\"{{ asset(\x27assets/formoid/formoid.min.js\x27) }}\"></script>
