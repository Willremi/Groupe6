...
class __TwigTemplate_059da490202b589750eb80af3e739e98 extends Template
{
...
";
    ...
    ";
        // line 28
        if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 28, $this->source); })()), "hasexception", [], "any", false, false, false, 28)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 29
    ...
    {
        return array (  179 => 34,  176 => 33,  170 => 29,  168 => 28,  164 => 26,  151 => 25,  139 => 22,  133 => 18,  131 => 17,  126 => 15,  121 => 14,  108 => 13,  94 => 10,  88 => 7,  84 => 6,  81 => 5,  78 => 4,  65 => 3,  42 => 1,);
    }
...
{% block head %}
    {% if collector.hasexception %}
        <style>
            {{ render(controller(\x27web_profiler.controller.exception_panel::stylesheet\x27, { token: token })) }}
            {{ include(\x27@WebProfiler/Collector/exception.css.twig\x27) }}
        </style>
    {% endif %}
    {{ parent() }}
{% endblock %}
...
{% block menu %}
    <span class=\"label {{ collector.hasexception ? \x27label-status-error\x27 : \x27disabled\x27 }}\">
        <span class=\"icon\">{{ include(\x27@WebProfiler/Icon/exception.svg\x27) }}</span>
        <strong>Exception</strong>
        {% if collector.hasexception %}
            <span class=\"count\">
                <span>1</span>
...
{% block panel %}
    ...
    {% else %}
        <div class=\"sf-reset\">
            {{ render(controller(\x27web_profiler.controller.exception_panel::body\x27, { token: token })) }}
        </div>
    {% endif %}
{% endblock %}
