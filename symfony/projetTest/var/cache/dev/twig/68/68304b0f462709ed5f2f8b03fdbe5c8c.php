...
class __TwigTemplate_365dcf1f381149baf7f686d24041ca1c extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        if ((array_key_exists("csp_script_nonce", $context) && (isset($context["csp_script_nonce"]) || array_key_exists("csp_script_nonce", $context) ? $context["csp_script_nonce"] : (function () { throw new RuntimeError('Variable "csp_script_nonce" does not exist.', 3, $this->source); })()))) {
            yield " nonce=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["csp_script_nonce"]) || array_key_exists("csp_script_nonce", $context) ? $context["csp_script_nonce"] : (function () { throw new RuntimeError('Variable "csp_script_nonce" does not exist.', 3, $this->source); })()), "html", null, true);
            yield "\"";
        }
        yield ">/*<![CDATA[*/
    ";
...
if (typeof Sfjs === \x27undefined\x27 || typeof Sfjs.loadToolbar === \x27undefined\x27) {
    Sfjs = (function() {
        ...
        if (navigator.clipboard) {
            document.querySelectorAll(\x27[data-clipboard-text]\x27).forEach(function(element) {
                removeClass(element, \x27hidden\x27);
                element.addEventListener(\x27click\x27, function() {
                    navigator.clipboard.writeText(element.getAttribute(\x27data-clipboard-text\x27));
                })
            });
        }
        ...
        var renderAjaxRequests = function() {
            ...
            if (requestStack.length) {
                ajaxToolbarPanel.style.display = \x27block\x27;
            } else {
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            // line 312
            yield json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 312, $this->source); })()));
            yield "))) {
            ...
            // line 359
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 359, $this->source); })()), "schemeAndHttpHost", [], "any", false, false, false, 359) . CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 359, $this->source); })()), "basePath", [], "any", false, false, false, 359)), "js"), "html", null, true);
            yield "\x27)) {
                        path = url.slice(";
            // line 360
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), (CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 360, $this->source); })()), "schemeAndHttpHost", [], "any", false, false, false, 360) . CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 360, $this->source); })()), "basePath", [], "any", false, false, false, 360))), "html", null, true);
            yield ");
                    }

                    if (!path.match(new RegExp(";
            // line 363
            yield json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 363, $this->source); })()));
            yield "))) {
                        var stackElement = {
                            error: false,
                            url: url,
        ...
        return {
            ...
            getSfwdt: function(token) {
                if (!this.sfwdt) {
                    this.sfwdt = document.getElementById(\x27sfwdt\x27 + token);
                }
            ...
            showToolbar: function(token) {
                ...
                removeClass(sfwdt, \x27sf-display-none\x27);

                if (getPreference(\x27toolbar/displayState\x27) == \x27none\x27) {
                    document.getElementById(\x27sfToolbarMainContent-\x27 + token).style.display = \x27none\x27;
                    document.getElementById(\x27sfToolbarClearer-\x27 + token).style.display = \x27none\x27;
                    document.getElementById(\x27sfMiniToolbar-\x27 + token).style.display = \x27block\x27;
                } else {
                    document.getElementById(\x27sfToolbarMainContent-\x27 + token).style.display = \x27block\x27;
                    document.getElementById(\x27sfToolbarClearer-\x27 + token).style.display = \x27block\x27;
                    document.getElementById(\x27sfMiniToolbar-\x27 + token).style.display = \x27none\x27;
                }
            },

            hideToolbar: function(token) {
                var sfwdt = this.getSfwdt(token);
                addClass(sfwdt, \x27sf-display-none\x27);
            },

            initToolbar: function(token) {
                this.showToolbar(token);

                var hideButton = document.getElementById(\x27sfToolbarHideButton-\x27 + token);
                var hideButtonSvg = hideButton.querySelector(\x27svg\x27);
                hideButtonSvg.setAttribute(\x27aria-hidden\x27, \x27true\x27);
                hideButtonSvg.setAttribute(\x27focusable\x27, \x27false\x27);
                addEventListener(hideButton, \x27click\x27, function (event) {
                    event.preventDefault();

                    var p = this.parentNode;
                    p.style.display = \x27none\x27;
                    (p.previousElementSibling || p.previousSibling).style.display = \x27none\x27;
                    document.getElementById(\x27sfMiniToolbar-\x27 + token).style.display = \x27block\x27;
                    setPreference(\x27toolbar/displayState\x27, \x27none\x27);
                });

                var showButton = document.getElementById(\x27sfToolbarMiniToggler-\x27 + token);
                var showButtonSvg = showButton.querySelector(\x27svg\x27);
                showButtonSvg.setAttribute(\x27aria-hidden\x27, \x27true\x27);
                showButtonSvg.setAttribute(\x27focusable\x27, \x27false\x27);
                addEventListener(showButton, \x27click\x27, function (event) {
                    event.preventDefault();

                    var elem = this.parentNode;
                    if (elem.style.display == \x27none\x27) {
                        document.getElementById(\x27sfToolbarMainContent-\x27 + token).style.display = \x27none\x27;
                        document.getElementById(\x27sfToolbarClearer-\x27 + token).style.display = \x27none\x27;
                        elem.style.display = \x27block\x27;
                    } else {
                        document.getElementById(\x27sfToolbarMainContent-\x27 + token).style.display = \x27block\x27;
                        document.getElementById(\x27sfToolbarClearer-\x27 + token).style.display = \x27block\x27;
                        elem.style.display = \x27none\x27
                    }

                    setPreference(\x27toolbar/displayState\x27, \x27block\x27);
                });
            },
        ...
        yield "\x27.replace(/xxxxxx/, newToken),
                    function(xhr, el) {
                        ...
                        if (!document.getElementById(\x27sfToolbarMainContent-\x27 + newToken)) {
                            return;
                        }
        ...
        yield "\x27 + newToken + \x27\">Open the web profiler.</a>\\
                            ...
                            \x27;
                            sfwdt.setAttribute(\x27class\x27, \x27sf-toolbar sf-error-toolbar\x27);
                        }
                    },
                    options
                );
            ...
            createTabs: function() {
                var tabGroups = document.querySelectorAll(\x27.sf-tabs:not([data-processed=true])\x27);

                /* create the tab navigation for each group of tabs */
                for (var i = 0; i < tabGroups.length; i++) {
                    var tabs = tabGroups[i].querySelectorAll(\x27:scope > .tab\x27);
                    var tabNavigation = document.createElement(\x27ul\x27);
                    tabNavigation.className = \x27tab-navigation\x27;

                    var selectedTabId = \x27tab-\x27 + i + \x27-0\x27; /* select the first tab by default */
                    for (var j = 0; j < tabs.length; j++) {
                        var tabId = \x27tab-\x27 + i + \x27-\x27 + j;
                        var tabTitle = tabs[j].querySelector(\x27.tab-title\x27).innerHTML;

                        var tabNavigationItem = document.createElement(\x27li\x27);
                        tabNavigationItem.setAttribute(\x27data-tab-id\x27, tabId);
                        if (hasClass(tabs[j], \x27active\x27)) { selectedTabId = tabId; }
                        if (hasClass(tabs[j], \x27disabled\x27)) { addClass(tabNavigationItem, \x27disabled\x27); }
                        tabNavigationItem.innerHTML = tabTitle;
                        tabNavigation.appendChild(tabNavigationItem);

                        var tabContent = tabs[j].querySelector(\x27.tab-content\x27);
                        tabContent.parentElement.setAttribute(\x27id\x27, tabId);
                    }

                    tabGroups[i].insertBefore(tabNavigation, tabGroups[i].firstChild);
                    addClass(document.querySelector(\x27[data-tab-id=\"\x27 + selectedTabId + \x27\"]\x27), \x27active\x27);
                }

                /* display the active tab and add the \x27click\x27 event listeners */
                for (i = 0; i < tabGroups.length; i++) {
                    tabNavigation = tabGroups[i].querySelectorAll(\x27:scope > .tab-navigation li\x27);

                    for (j = 0; j < tabNavigation.length; j++) {
                        tabId = tabNavigation[j].getAttribute(\x27data-tab-id\x27);
                        document.getElementById(tabId).querySelector(\x27.tab-title\x27).className = \x27hidden\x27;

                        if (hasClass(tabNavigation[j], \x27active\x27)) {
                            document.getElementById(tabId).className = \x27block\x27;
                        } else {
                            document.getElementById(tabId).className = \x27hidden\x27;
                        }

                        tabNavigation[j].addEventListener(\x27click\x27, function(e) {
                            var activeTab = e.target || e.srcElement;

                            /* needed because when the tab contains HTML contents, user can click */
                            /* on any of those elements instead of their parent \x27<li>\x27 element */
                            while (activeTab.tagName.toLowerCase() !== \x27li\x27) {
                            ...
                            for (var k = 0; k < tabNavigation.length; k++) {
                                var tabId = tabNavigation[k].getAttribute(\x27data-tab-id\x27);
                                document.getElementById(tabId).className = \x27hidden\x27;
                                removeClass(tabNavigation[k], \x27active\x27);
                            }

                            addClass(activeTab, \x27active\x27);
                            var activeTabId = activeTab.getAttribute(\x27data-tab-id\x27);
                            document.getElementById(activeTabId).className = \x27block\x27;
                        });
                    }

                    tabGroups[i].setAttribute(\x27data-processed\x27, \x27true\x27);
                }
            },

            createToggles: function() {
                var toggles = document.querySelectorAll(\x27.sf-toggle:not([data-processed=true])\x27);

                for (var i = 0; i < toggles.length; i++) {
                    var elementSelector = toggles[i].getAttribute(\x27data-toggle-selector\x27);
                    var element = document.querySelector(elementSelector);

                    addClass(element, \x27sf-toggle-content\x27);

                    if (toggles[i].hasAttribute(\x27data-toggle-initial\x27) && toggles[i].getAttribute(\x27data-toggle-initial\x27) == \x27display\x27) {
                        addClass(toggles[i], \x27sf-toggle-on\x27);
                        addClass(element, \x27sf-toggle-visible\x27);
                    } else {
                        addClass(toggles[i], \x27sf-toggle-off\x27);
                        addClass(element, \x27sf-toggle-hidden\x27);
                    }

                    addEventListener(toggles[i], \x27click\x27, function(e) {
                        e.preventDefault();
                        ...
                        /* on any of those elements instead of their parent \x27.sf-toggle\x27 element */
                        while (!hasClass(toggle, \x27sf-toggle\x27)) {
                            toggle = toggle.parentNode;
                        }

                        var element = document.querySelector(toggle.getAttribute(\x27data-toggle-selector\x27));

                        toggleClass(toggle, \x27sf-toggle-on\x27);
                        toggleClass(toggle, \x27sf-toggle-off\x27);
                        toggleClass(element, \x27sf-toggle-hidden\x27);
                        toggleClass(element, \x27sf-toggle-visible\x27);
                        ...
                        var originalContent = toggle.getAttribute(\x27data-toggle-original-content\x27);
                        var altContent = toggle.getAttribute(\x27data-toggle-alt-content\x27);
                        toggle.innerHTML = currentContent !== altContent ? altContent : originalContent;
                    });

                    /* Prevents from disallowing clicks on links inside toggles */
                    var toggleLinks = toggles[i].querySelectorAll(\x27a\x27);
                    for (var j = 0; j < toggleLinks.length; j++) {
                        addEventListener(toggleLinks[j], \x27click\x27, function(e) {
                            e.stopPropagation();
                        });
                    }

                    /* Prevents from disallowing clicks on \"copy to clipboard\" elements inside toggles */
                    var copyToClipboardElements = toggles[i].querySelectorAll(\x27span[data-clipboard-text]\x27);
                    for (var k = 0; k < copyToClipboardElements.length; k++) {
                        addEventListener(copyToClipboardElements[k], \x27click\x27, function(e) {
                            e.stopPropagation();
                        });
                    }

                    toggles[i].setAttribute(\x27data-processed\x27, \x27true\x27);
                }
            },
            ...
            initializeLogsTable: function() {
                ...
                document.querySelectorAll(\x27.log-filter input\x27).forEach((input) => {
                    input.addEventListener(\x27change\x27, () => { Sfjs.updateLogsTable(); });
                });
            ...
            updateLogsTable: function() {
                ...
                document.querySelectorAll(\x27#log-filter-type li\x27).forEach((tab) => tab.classList.remove(\x27active\x27));
                document.querySelector(`#log-filter-type input[value=\"\${selectedType}\"]`).parentElement.classList.add(\x27active\x27);
            },
        };
    })();

    Sfjs.addEventListener(document, \x27DOMContentLoaded\x27, function() {
        Sfjs.createTabs();
        Sfjs.createToggles();
    });
}
...
";
    ...
    {
        return array (  701 => 623,  615 => 540,  465 => 392,  433 => 363,  427 => 360,  423 => 359,  417 => 356,  413 => 355,  367 => 312,  346 => 293,  344 => 292,  57 => 7,  48 => 3,);
    }
    ...
    Sfjs = (function() {
        ...
        return {
            ...
            loadToolbar: function(token, newToken) {
                ...
                this.load(
                    \x27sfwdt\x27 + token,
                    \x27{{ url(\"_wdt\", { \"token\": \"xxxxxx\" })|escape(\x27js\x27) }}\x27.replace(/xxxxxx/, newToken),
                    function(xhr, el) {
                        /* Do nothing in the edge case where the toolbar has already been replaced with a new one */
                        if (!document.getElementById(\x27sfToolbarMainContent-\x27 + newToken)) {
                            return;
                    ...
                    function(xhr) {
                        if (xhr.status !== 0 && !options.stop) {
                            ...
                            sfwdt.innerHTML = \x27\\
                                <div class=\"sf-toolbarreset\">\\
                                    <div class=\"sf-toolbar-icon\"><svg width=\"26\" height=\"28\" xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 26 28\" enable-background=\"new 0 0 26 28\" xml:space=\"preserve\"><path fill=\"#FFFFFF\" d=\"M13 0C5.8 0 0 5.8 0 13c0 7.2 5.8 13 13 13c7.2 0 13-5.8 13-13C26 5.8 20.2 0 13 0z M20 7.5 c-0.6 0-1-0.3-1-0.9c0-0.2 0-0.4 0.2-0.6c0.1-0.3 0.2-0.3 0.2-0.4c0-0.3-0.5-0.4-0.7-0.4c-2 0.1-2.5 2.7-2.9 4.8l-0.2 1.1 c1.1 0.2 1.9 0 2.4-0.3c0.6-0.4-0.2-0.8-0.1-1.3C18 9.2 18.4 9 18.7 8.9c0.5 0 0.8 0.5 0.8 1c0 0.8-1.1 2-3.3 1.9 c-0.3 0-0.5 0-0.7-0.1L15 14.1c-0.4 1.7-0.9 4.1-2.6 6.2c-1.5 1.8-3.1 2.1-3.8 2.1c-1.3 0-2.1-0.6-2.2-1.6c0-0.9 0.8-1.4 1.3-1.4 c0.7 0 1.2 0.5 1.2 1.1c0 0.5-0.2 0.6-0.4 0.7c-0.1 0.1-0.3 0.2-0.3 0.4c0 0.1 0.1 0.3 0.4 0.3c0.5 0 0.9-0.3 1.2-0.5 c1.3-1 1.7-2.9 2.4-6.2l0.1-0.8c0.2-1.1 0.5-2.3 0.8-3.5c-0.9-0.7-1.4-1.5-2.6-1.8c-0.8-0.2-1.3 0-1.7 0.4C8.4 10 8.6 10.7 9 11.1 l0.7 0.7c0.8 0.9 1.3 1.7 1.1 2.7c-0.3 1.6-2.1 2.8-4.3 2.1c-1.9-0.6-2.2-1.9-2-2.7c0.2-0.6 0.7-0.8 1.2-0.6 c0.5 0.2 0.7 0.8 0.6 1.3c0 0.1 0 0.1-0.1 0.3C6 15 5.9 15.2 5.9 15.3c-0.1 0.4 0.4 0.7 0.8 0.8c0.8 0.3 1.7-0.2 1.9-0.9 c0.2-0.6-0.2-1.1-0.4-1.2l-0.8-0.9c-0.4-0.4-1.2-1.5-0.8-2.8c0.2-0.5 0.5-1 0.9-1.4c1-0.7 2-0.8 3-0.6c1.3 0.4 1.9 1.2 2.8 1.9 c0.5-1.3 1.1-2.6 2-3.8c0.9-1 2-1.7 3.3-1.8C20 4.8 21 5.4 21 6.3C21 6.7 20.8 7.5 20 7.5z\"/></svg></div>\\
                                    An error occurred while loading the web debug toolbar. <a href=\"{{ url(\"_profiler_home\")|escape(\x27js\x27) }}\x27 + newToken + \x27\">Open the web profiler.</a>\\
                                </div>\\
                            \x27;
                            sfwdt.setAttribute(\x27class\x27, \x27sf-toolbar sf-error-toolbar\x27);
                        }
...
/*]]>*/</script>
", "@WebProfiler/Profiler/base_js.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\base_js.html.twig");
    }
}
