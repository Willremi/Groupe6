...
class __TwigTemplate_700f17d340ebe3330b676b9e5e63cee5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        // line 67
        yield ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 67, $this->source); })()), "messages", [], "any", false, false, false, 67))) ? ("") : ("disabled"));
        yield "\">
        <span class=\"icon\">";
        // line 68
