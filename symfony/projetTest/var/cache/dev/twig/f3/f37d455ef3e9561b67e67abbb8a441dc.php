...
class __TwigTemplate_f2b46a5b0185cf4c8e3b8d077f169f4a extends Template
{
            ...
            $context["text"] = ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["dump"]) {
                    ...
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["dump"], "file", [], "any", false, false, false, 14)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        ...
                        // line 16
                        yield "                        ";
                        if ((($tmp = (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 16, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            // line 17
                            yield "                            <a href=\"";
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dump"]) {
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["dump"], "line", [], "any", false, false, false, 49)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                // line 51
                yield "                    ";
                if ((($tmp = (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 51, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 52
                    yield "                        <a href=\"";
    ...
    {
        return array (  327 => 71,  325 => 70,  310 => 68,  303 => 64,  298 => 62,  289 => 59,  283 => 57,  280 => 56,  272 => 54,  262 => 52,  259 => 51,  256 => 50,  254 => 49,  250 => 47,  232 => 46,  228 => 44,  215 => 43,  200 => 38,  195 => 37,  182 => 36,  168 => 32,  165 => 31,  161 => 30,  152 => 27,  147 => 25,  144 => 24,  138 => 22,  135 => 21,  127 => 19,  117 => 17,  114 => 16,  111 => 15,  109 => 14,  105 => 12,  100 => 11,  98 => 10,  95 => 9,  89 => 7,  84 => 6,  81 => 5,  78 => 4,  65 => 3,  42 => 1,);
    }
...
{% block toolbar %}
    {% if collector.dumpsCount %}
        {% set icon %}
            {{ include(\x27@Debug/Profiler/icon.svg\x27) }}
            <span class=\"sf-toolbar-value\">{{ collector.dumpsCount }}</span>
        {% endset %}

        {% set text %}
            {% for dump in collector.getDumps(\x27html\x27) %}
        ...
        {{ include(\x27@WebProfiler/Profiler/toolbar_item.html.twig\x27, { \x27link\x27: true }) }}
    {% endif %}
{% endblock %}

{% block menu %}
    <span class=\"label {{ collector.dumpsCount == 0 ? \x27disabled\x27 }}\">
        <span class=\"icon\">{{ include(\x27@Debug/Profiler/icon.svg\x27) }}</span>
        <strong>Debug</strong>
    </span>
{% endblock %}
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\symfony\\debug-bundle\\Resources\\views\\Profiler\\dump.html.twig");
    }
}
