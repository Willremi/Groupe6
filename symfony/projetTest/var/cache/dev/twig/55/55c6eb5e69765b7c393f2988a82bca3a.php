...
class __TwigTemplate_25be88bf5084299c2fdb0d7c8dd0b551 extends Template
{
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        if (((CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "violationsCount", [], "any", false, false, false, 4) > 0) || Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "calls", [], "any", false, false, false, 4)))) {
            // line 5
            yield "        ";
            $context["status_color"] = (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 5, $this->source); })()), "violationsCount", [], "any", false, false, false, 5)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("red") : (""));
            // line 6
            yield "        ";
    ...
    public function block_menu(array $context, array $blocks = []): iterable
    {
        ...
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 29, $this->source); })()), "violationsCount", [], "any", false, false, false, 29)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (" label-status-error") : (""));
        yield " ";
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
            ...
            // line 47
            yield "                ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["caller"]) || array_key_exists("caller", $context) ? $context["caller"] : (function () { throw new RuntimeError('Variable "caller" does not exist.', 47, $this->source); })()), "line", [], "any", false, false, false, 47)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 48
                yield "                    ";
                ...
                // line 49
                yield "                    ";
                if ((($tmp = (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 49, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 50
                    yield "                        <a href=\"";
...
{% block toolbar %}
    {% if collector.violationsCount > 0 or collector.calls|length %}
        {% set status_color = collector.violationsCount ? \x27red\x27 %}
        {% set icon %}
            {{ include(\x27@WebProfiler/Icon/validator.svg\x27) }}
            <span class=\"sf-toolbar-value\">
        ...
        {% set text %}
            ...
            <div class=\"sf-toolbar-info-piece\">
                <b>Number of violations</b>
                <span class=\"sf-toolbar-status {{- collector.violationsCount > 0 ? \x27 sf-toolbar-status-red\x27 }}\">{{ collector.violationsCount }}</span>
            </div>
        {% endset %}
...
{% block menu %}
    <span class=\"label {{- collector.violationsCount ? \x27 label-status-error\x27 }} {{ collector.calls is empty ? \x27disabled\x27 }}\">
        <span class=\"icon\">{{ include(\x27@WebProfiler/Icon/validator.svg\x27) }}</span>
        <strong>Validator</strong>
...
{% block panel %}
                ...
                <table>
                    ...
                    {% for violation in call.violations %}
                        <tr>
                            ...
                            <td>{{ profiler_dump(violation.seek(\x27invalidValue\x27)) }}</td>
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\validator.html.twig");
    }
}
