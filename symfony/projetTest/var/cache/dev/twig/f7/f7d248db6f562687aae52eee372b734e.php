...
class __TwigTemplate_0809b7d0bc824e36af4f66ce624a6769 extends Template
{
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        // line 7
        yield "    ";
        $context["total_time"] = (((($tmp = (isset($context["has_time_events"]) || array_key_exists("has_time_events", $context) ? $context["has_time_events"] : (function () { throw new RuntimeError('Variable "has_time_events" does not exist.', 7, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::sprintf("%.0f", CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 7, $this->source); })()), "duration", [], "any", false, false, false, 7))) : ("n/a"));
        // line 8
        yield "    ";
        $context["initialization_time"] = (((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 8, $this->source); })()), "events", [], "any", false, false, false, 8))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::sprintf("%.0f", CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 8, $this->source); })()), "inittime", [], "any", false, false, false, 8))) : ("n/a"));
        // line 9
        yield "    ";
...
";
    ...
    <div class=\"metrics\">
        ...
        ";
        // line 53
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 53, $this->source); })()), "collectors", [], "any", false, false, false, 53), "memory", [], "any", false, false, false, 53)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 54
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 60, $this->source); })()), "children", [], "any", false, false, false, 60)) > 0)) {
            ...
            ";
            // line 68
            if ((($tmp = (isset($context["has_time_events"]) || array_key_exists("has_time_events", $context) ? $context["has_time_events"] : (function () { throw new RuntimeError('Variable "has_time_events" does not exist.', 68, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 69
                yield "                ";
    ...
    ";
        // line 86
        if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 86, $this->source); })()), "isStopwatchInstalled", [], "method", false, false, false, 86)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 87
...
(isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 90, $this->source); })()), "events", [], "any", false, false, false, 90))) {
    ...
    ";
        // line 107
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 107, $this->source); })()), "parent", [], "any", false, false, false, 107)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 108
...
(isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 115, $this->source); })()), "children", [], "any", false, false, false, 115)) > 0)) {
    ...
    ";
        // line 123
        if ((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 123, $this->source); })()), "children", [], "any", false, false, false, 123))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 124
...
";
    ...
    public function macro_display_timeline($token = null, $events = null, $origin = null, ...$varargs): string|Markup
    {
        ...
        <script>";
            // line 201
            yield "            window.addEventListener(\x27load\x27, function onLoad() {
                const theme = new Theme();

                new TimelineEngine(
                    theme,
                    new SvgRenderer(document.getElementById(\x27timeline-";
            // line 206
            ...
            yield "\x27)),
                    new Legend(document.getElementById(\x27legend-";
            // line 207
            ...
            yield "\x27), theme),
                    document.getElementById(\x27threshold\x27),
                    ";
            // line 209
...
{% block toolbar %}
    ...
    {% set total_time = has_time_events ? \x27%.0f\x27|format(collector.duration) : \x27n/a\x27 %}
    {% set initialization_time = collector.events|length ? \x27%.0f\x27|format(collector.inittime) : \x27n/a\x27 %}
    {% set status_color = has_time_events and collector.duration > 1000 ? \x27yellow\x27 %}

    {% set icon %}
        {{ include(\x27@WebProfiler/Icon/time.svg\x27) }}
...
{% block menu %}
    <span class=\"label\">
        <span class=\"icon\">{{ include(\x27@WebProfiler/Icon/time.svg\x27) }}</span>
        <strong>Performance</strong>
    </span>
{% endblock %}
...
{% block panel %}
    ...
    <div class=\"metrics\">
        <div class=\"metric\">
            <span class=\"value\">{{ \x27%.0f\x27|format(collector.duration) }} <span class=\"unit\">ms</span></span>
            <span class=\"label\">Total execution time</span>
        </div>

        <div class=\"metric\">
            <span class=\"value\">{{ \x27%.0f\x27|format(collector.inittime) }} <span class=\"unit\">ms</span></span>
            <span class=\"label\">Symfony initialization</span>
        </div>

        {% if profile.collectors.memory %}
            <div class=\"metric\">
                <span class=\"value\">{{ \x27%.2f\x27|format(profile.collectors.memory.memory / 1024 / 1024) }} <span class=\"unit\">MiB</span></span>
                <span class=\"label\">Peak memory usage</span>
            </div>
        {% endif %}
        ...
        {% if profile.children|length > 0 %}
            ...
            <div class=\"metric\">
                ...
                <span class=\"label\">Sub-Request{{ profile.children|length > 1 ? \x27s\x27 }}</span>
            </div>

            {% if has_time_events %}
                {% set subrequests_time = 0 %}
                {% for child in profile.children %}
                    {% set subrequests_time = subrequests_time + child.getcollector(\x27time\x27).events.__section__.duration %}
                {% endfor %}
            {% else %}
                {% set subrequests_time = \x27n/a\x27 %}
            {% endif %}

            <div class=\"metric\">
                <span class=\"value\">{{ subrequests_time }} <span class=\"unit\">ms</span></span>
                <span class=\"label\">Sub-Request{{ profile.children|length > 1 ? \x27s\x27 }} time</span>
            </div>
        {% endif %}
    </div>
...
{% block panelContent %}
    ...
    {% if profile.parent %}
        <h3 class=\"dump-inline\">
            Sub-Request {{ profiler_dump(profile.getcollector(\x27request\x27).requestattributes.get(\x27_controller\x27)) }}
            <small>
                {{ collector.events.__section__.duration }} ms
                <a class=\"newline\" href=\"{{ path(\x27_profiler\x27, { token: profile.parent.token, panel: \x27time\x27 }) }}\">Return to parent request</a>
            </small>
        </h3>
    ...
    {% if profile.children|length %}
        ...
        {% for child in profile.children %}
            {% set events = child.getcollector(\x27time\x27).events %}
            <h4>
                <a href=\"{{ path(\x27_profiler\x27, { token: child.token, panel: \x27time\x27 }) }}\">{{ child.getcollector(\x27request\x27).identifier }}</a>
...
<style type=\"text/css\">
{% include \x27@WebProfiler/Collector/time.css.twig\x27 %}
</style>
<script>
{% include \x27@WebProfiler/Collector/time.js\x27 %}
</script>
{% endblock %}

{% macro dump_request_data(token, events, origin) %}
{% autoescape \x27js\x27 %}
{% from _self import dump_events %}
{
    id: \"{{ token }}\",
    left: {{ \"%F\"|format(events.__section__.origin - origin) }},
    end: \"{{ \x27%F\x27|format(events.__section__.endtime) }}\",
...
{% import _self as helper %}
    <div class=\"sf-profiler-timeline\">
        ...
        <script>{% autoescape \x27js\x27 %}
            window.addEventListener(\x27load\x27, function onLoad() {
                const theme = new Theme();

                new TimelineEngine(
                    theme,
                    new SvgRenderer(document.getElementById(\x27timeline-{{ token }}\x27)),
                    new Legend(document.getElementById(\x27legend-{{ token }}\x27), theme),
                    document.getElementById(\x27threshold\x27),
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\time.html.twig");
    }
}
