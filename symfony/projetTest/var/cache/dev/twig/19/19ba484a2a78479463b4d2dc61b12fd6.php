...
class __TwigTemplate_645b8be9e627a3dcbc52d51a4260471c extends Template
{
...
<p>
    ...
    This link will expire in ";
        // line 6
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate((isset($context["expiresAt"]) || array_key_exists("expiresAt", $context) ? $context["expiresAt"] : (function () { throw new RuntimeError('Variable "expiresAt" does not exist.', 6, $this->source); })()), "g"), "html", null, true);
        yield " hour(s).
</p>
...
<p>
    ...
    This link will expire in {{ expiresAt|date(\x27g\x27) }} hour(s).
</p>

<p>
    Cheers!
</p>
", "registration/confirmation_email.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\templates\\registration\\confirmation_email.html.twig");
    }
}
