...
class __TwigTemplate_1f95d0902a21a3363d6c6c3bd45ceaed extends Template
{
...
";
    ...
    <table style=\"margin: 5px 0;\">
        ...
        <tbody>
            ...
            <tr>
                {% for key, item in row %}
                    <td>{{ item|replace({\x27,\x27: \x27, \x27}) }}</td>
                {% endfor %}
            </tr>
            {% endfor %}
        </tbody>
...
{% endif %}
", "@Doctrine/Collector/explain.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\doctrine\\doctrine-bundle\\Resources\\views\\Collector\\explain.html.twig");
    }
}
