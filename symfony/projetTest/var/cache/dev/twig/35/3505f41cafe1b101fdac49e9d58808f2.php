...
class __TwigTemplate_511684cc3e7199cf13c39b554687a0fe extends Template
{
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        // line 4
        yield "    ";
        $context["time"] = (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "templatecount", [], "any", false, false, false, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::sprintf("%0.0f", CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "time", [], "any", false, false, false, 4))) : ("n/a"));
        // line 5
        yield "    ";
    ...
    ";
        ...
        <table id=\"twig-table\">
            ...
            foreach ($context['_seq'] as $context["template"] => $context["count"]) {
                ...
                // line 89
                $context["link"] = (((($tmp = (isset($context["file"]) || array_key_exists("file", $context) ? $context["file"] : (function () { throw new RuntimeError('Variable "file" does not exist.', 89, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->getFileLink((isset($context["file"]) || array_key_exists("file", $context) ? $context["file"] : (function () { throw new RuntimeError('Variable "file" does not exist.', 89, $this->source); })()), 1)) : (false));
                // line 90
                yield "<td>
                ...
                yield "</span>
                        ";
                // line 92
                if ((($tmp = (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 92, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 93
                    yield "                            <a href=\"";
...
{% block toolbar %}
    {% set time = collector.templatecount ? \x27%0.0f\x27|format(collector.time) : \x27n/a\x27 %}
    {% set icon %}
        {{ include(\x27@WebProfiler/Icon/twig.svg\x27) }}
...
{% block menu %}
    <span class=\"label {{ 0 == collector.templateCount ? \x27disabled\x27 }}\">
        <span class=\"icon\">{{ include(\x27@WebProfiler/Icon/twig.svg\x27) }}</span>
        <strong>Twig</strong>
    </span>
{% endblock %}
...
{% block panel %}
    ...
    {% else %}
        ...
        <div class=\"metrics\">
            <div class=\"metric\">
                <span class=\"value\">{{ \x27%0.0f\x27|format(collector.time) }} <span class=\"unit\">ms</span></span>
                <span class=\"label\">Render time</span>
            </div>
        ...
        <table id=\"twig-table\">
            ...
            {% for template, count in collector.templates %}
                <tr>
                    ...
                    <td>
                        <span class=\"sf-icon icon-twig\">{{ include(\x27@WebProfiler/Icon/twig.svg\x27) }}</span>
                        {% if link %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/twig.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\twig.html.twig");
    }
}
