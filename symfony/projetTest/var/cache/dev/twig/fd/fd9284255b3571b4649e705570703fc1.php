...
class __TwigTemplate_533100060cfdd53fc4171e1ce81d180c extends Template
{
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 6, $this->source); })()), "messages", [], "any", false, false, false, 6)) > 0)) {
            // line 7
            yield "        ";
            $context["status_color"] = (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 7, $this->source); })()), "exceptionsCount", [], "any", false, false, false, 7)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("red") : (""));
            // line 8
            yield "        ";
        ...
        ";
            ...
            $context["text"] = ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["bus"]) {
                    ...
                    // line 20
                    yield (((($tmp = (isset($context["exceptionsCount"]) || array_key_exists("exceptionsCount", $context) ? $context["exceptionsCount"] : (function () { throw new RuntimeError('Variable "exceptionsCount" does not exist.', 20, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("red") : (""));
                    yield "\"
                    >
                        ";
                    // line 22
    ...
    public function block_menu(array $context, array $blocks = []): iterable
    {
        ...
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 33, $this->source); })()), "exceptionsCount", [], "any", false, false, false, 33)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (" label-status-error") : (""));
...
";
    ...
    ";
            ...
            yield (((($tmp = (isset($context["exceptionsCount"]) || array_key_exists("exceptionsCount", $context) ? $context["exceptionsCount"] : (function () { throw new RuntimeError('Variable "exceptionsCount" does not exist.', 79, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (((((isset($context["exceptionsCount"]) || array_key_exists("exceptionsCount", $context) ? $context["exceptionsCount"] : (function () { throw new RuntimeError('Variable "exceptionsCount" does not exist.', 79, $this->source); })()) == Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 79, $this->source); })())))) ? ("status-error") : ("status-some-errors"))) : (""));
            yield "\">";
            ...
            yield "</span></h3>
                ...
                <div class=\"tab-content\">
                    ...
                    ";
            // line 83
            yield $macros["helper"]->getTemplateForMacro("macro_render_bus_messages", $context, 83, $this->getSourceContext())->macro_render_bus_messages(...[(isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 83, $this->source); })()), true]);
            yield "
                </div>
            </div>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["bus"]) {
                ...
                yield (((($tmp = (isset($context["exceptionsCount"]) || array_key_exists("exceptionsCount", $context) ? $context["exceptionsCount"] : (function () { throw new RuntimeError('Variable "exceptionsCount" does not exist.', 91, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (((((isset($context["exceptionsCount"]) || array_key_exists("exceptionsCount", $context) ? $context["exceptionsCount"] : (function () { throw new RuntimeError('Variable "exceptionsCount" does not exist.', 91, $this->source); })()) == Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 91, $this->source); })())))) ? ("status-error") : ("status-some-errors"))) : (""));
                yield "\">";
                ...
                yield "</code> bus</p>
                        ";
                // line 95
                yield $macros["helper"]->getTemplateForMacro("macro_render_bus_messages", $context, 95, $this->getSourceContext())->macro_render_bus_messages(...[(isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 95, $this->source); })())]);
                yield "
                    </div>
                </div>
            ";
...
";
    ...
    public function macro_render_bus_messages($messages = null, $showBus = false, ...$varargs): string|Markup
    {
        ...
        <thead>
            <tr>
                ...
                yield "</span>
                    ";
                // line 115
                if ((($tmp = (isset($context["showBus"]) || array_key_exists("showBus", $context) ? $context["showBus"] : (function () { throw new RuntimeError('Variable "showBus" does not exist.', 115, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 116
                    yield "                        <span class=\"label\">";
        ...
        <tbody id=\"message-item-";
            ...
            <tr>
                ...
                // line 133
                yield "                        ";
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["caller"]) || array_key_exists("caller", $context) ? $context["caller"] : (function () { throw new RuntimeError('Variable "caller" does not exist.', 133, $this->source); })()), "line", [], "any", false, false, false, 133)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 134
                    yield "                            ";
                    ...
                    // line 135
                    yield "                            ";
                    if ((($tmp = (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 135, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 136
                        yield "                                <a href=\"";
            ...
            ";
                // line 158
                if ((($tmp = (isset($context["showBus"]) || array_key_exists("showBus", $context) ? $context["showBus"] : (function () { throw new RuntimeError('Variable "showBus" does not exist.', 158, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 159
                    yield "                <tr>
    ...
    {
        return array (  624 => 198,  617 => 194,  612 => 191,  609 => 190,  604 => 187,  597 => 185,  595 => 184,  588 => 183,  583 => 182,  578 => 179,  576 => 178,  572 => 176,  565 => 174,  563 => 173,  556 => 172,  551 => 171,  543 => 166,  539 => 164,  533 => 161,  529 => 159,  527 => 158,  520 => 153,  518 => 148,  511 => 146,  500 => 143,  494 => 141,  491 => 140,  483 => 138,  473 => 136,  470 => 135,  467 => 134,  464 => 133,  462 => 132,  453 => 128,  445 => 123,  441 => 122,  438 => 121,  434 => 119,  431 => 118,  425 => 116,  423 => 115,  419 => 114,  414 => 112,  408 => 111,  402 => 107,  384 => 106,  381 => 105,  362 => 104,  350 => 101,  346 => 99,  336 => 95,  332 => 94,  321 => 91,  318 => 90,  316 => 89,  313 => 88,  309 => 87,  302 => 83,  292 => 79,  289 => 78,  287 => 77,  283 => 75,  277 => 71,  275 => 70,  270 => 67,  267 => 66,  254 => 65,  223 => 45,  210 => 44,  198 => 41,  192 => 38,  189 => 37,  187 => 36,  182 => 34,  176 => 33,  163 => 32,  149 => 28,  146 => 27,  142 => 26,  132 => 22,  127 => 20,  123 => 19,  118 => 17,  115 => 16,  112 => 15,  107 => 14,  105 => 13,  102 => 12,  96 => 10,  91 => 9,  88 => 8,  85 => 7,  82 => 6,  69 => 5,  58 => 1,  56 => 3,  43 => 1,);
    }
...
{% block toolbar %}
    {% if collector.messages|length > 0 %}
        ...
        {% set icon %}
            {{ include(\x27@WebProfiler/Icon/messenger.svg\x27) }}
...
{% block menu %}
    <span class=\"label{{ collector.exceptionsCount ? \x27 label-status-error\x27 }}{{ collector.messages is empty ? \x27 disabled\x27 }}\">
        <span class=\"icon\">{{ include(\x27@WebProfiler/Icon/messenger.svg\x27) }}</span>
        <strong>Messages</strong>
...
{% macro render_bus_messages(messages, showBus = false) %}
            ...
            <tr>
                ...
                >
                    ...
                    <a class=\"toggle-button\">
                        <span class=\"icon icon-close\">{{ include(\x27@WebProfiler/images/icon-minus-square.svg\x27) }}</span>
                        <span class=\"icon icon-open\">{{ include(\x27@WebProfiler/images/icon-plus-square.svg\x27) }}</span>
                    </a>
                </th>
            </tr>
        </thead>
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\messenger.html.twig");
    }
}
