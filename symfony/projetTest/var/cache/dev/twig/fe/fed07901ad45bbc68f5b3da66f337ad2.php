...
class __TwigTemplate_3f5db777fac02faa7de48364f1dceecc extends Template
{
    ...
    <table class=\"table\">
        ...
        unset($context['_seq'], $context['_key'], $context['adresse'], $context['_parent'], $context['_iterated']);
...
";
    ...
    {
        return array (  177 => 44,  172 => 41,  163 => 37,  161 => 36,  151 => 31,  145 => 28,  140 => 26,  136 => 25,  132 => 24,  128 => 23,  124 => 22,  121 => 21,  116 => 20,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for adresse in adresses %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path(\x27adresse_show\x27, {\x27id\x27: adresse.id}) }}\">
                        <button type=\"button\" class=\"btn btn-outline-dark\">Voir</button>
                    </a>
    ...
    <a href=\"{{ path(\x27adresse_new\x27) }}\">
        <button type=\"button\" class=\"btn btn-outline-dark\">Créer</button>
    </a>
{% endblock %}
