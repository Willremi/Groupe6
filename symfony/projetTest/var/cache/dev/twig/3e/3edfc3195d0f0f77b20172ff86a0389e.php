...
class __TwigTemplate_920fe42ae35e9c8f7008447c88c9e26b extends Template
{
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        // line 4
        yield "    ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "requestCount", [], "any", false, false, false, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 5
            yield "        ";
    ...
    ";
        // line 30
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 30, $this->source); })()), "requestCount", [], "any", false, false, false, 30)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 31
            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                ...
                if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 61)) == 0)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                        ...
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["responseStatus"]) || array_key_exists("responseStatus", $context) ? $context["responseStatus"] : (function () { throw new RuntimeError('Variable "responseStatus" does not exist.', 109, $this->source); })()), "html", null, true);
                        yield "\">
                                                ";
                        // line 110
                        ...
                        if (((isset($context["profiler_token"]) || array_key_exists("profiler_token", $context) ? $context["profiler_token"] : (function () { throw new RuntimeError('Variable "profiler_token" does not exist.', 116, $this->source); })()) && (isset($context["profiler_link"]) || array_key_exists("profiler_link", $context) ? $context["profiler_link"] : (function () { throw new RuntimeError('Variable "profiler_link" does not exist.', 116, $this->source); })()))) {
                            ...
                            yield "                                            <td>
                                                <span><a href=\"";
                            // line 118
                            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["profiler_link"]) || array_key_exists("profiler_link", $context) ? $context["profiler_link"] : (function () { throw new RuntimeError('Variable "profiler_link" does not exist.', 118, $this->source); })()), "html", null, true);
                            yield "\" target=\"_blank\">";
                            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["profiler_token"]) || array_key_exists("profiler_token", $context) ? $context["profiler_token"] : (function () { throw new RuntimeError('Variable "profiler_token" does not exist.', 118, $this->source); })()), "html", null, true);
                            yield "</a></span>
                                            </td>
                                        ";
                        }
...
";
    ...
    {
        return array (  420 => 130,  417 => 129,  409 => 126,  406 => 125,  397 => 121,  389 => 118,  386 => 117,  384 => 116,  379 => 114,  372 => 110,  367 => 109,  364 => 108,  361 => 107,  358 => 106,  355 => 105,  352 => 104,  349 => 103,  347 => 102,  340 => 97,  334 => 93,  332 => 92,  329 => 91,  323 => 89,  321 => 88,  317 => 87,  311 => 84,  305 => 80,  302 => 79,  296 => 78,  293 => 77,  290 => 76,  287 => 75,  284 => 74,  281 => 73,  278 => 72,  273 => 71,  270 => 70,  267 => 69,  264 => 68,  260 => 67,  257 => 66,  251 => 63,  248 => 62,  246 => 61,  239 => 59,  234 => 58,  230 => 57,  221 => 51,  214 => 47,  210 => 45,  204 => 41,  202 => 40,  199 => 39,  186 => 38,  174 => 35,  168 => 32,  165 => 31,  163 => 30,  158 => 28,  153 => 27,  140 => 26,  126 => 22,  123 => 21,  114 => 18,  107 => 14,  103 => 12,  101 => 11,  98 => 10,  91 => 8,  89 => 7,  84 => 6,  81 => 5,  78 => 4,  65 => 3,  42 => 1,);
    }
...
{% block toolbar %}
    {% if collector.requestCount %}
        {% set icon %}
            {{ include(\x27@WebProfiler/Icon/http-client.svg\x27) }}
...
<span class=\"label {{ collector.requestCount == 0 ? \x27disabled\x27 }}\">
    <span class=\"icon\">{{ include(\x27@WebProfiler/Icon/http-client.svg\x27) }}</span>
    <strong>HTTP Client</strong>
    {% if collector.requestCount %}
        <span class=\"count\">
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\http_client.html.twig");
    }
}
