...
class __TwigTemplate_f8e6e850db6d302c63b1aa98ad9fe81f extends Template
{
    ...
    ";
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            // line 13
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "username", [], "any", false, false, false, 13), "html", null, true);
            yield ", <a href=\"";
...
";
    ...
    {
        return array (  146 => 37,  140 => 24,  132 => 19,  127 => 16,  119 => 13,  116 => 12,  114 => 11,  111 => 10,  105 => 8,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            You are logged in as {{ app.user.username }}, <a href=\"{{ path(\x27logout\x27) }}\">Logout</a>
        </div>
    {% endif %}
    ...
    <input type=\"hidden\" name=\"_csrf_token\"
           value=\"{{ csrf_token(\x27authenticate\x27) }}\"
    >
...
{% endblock %}
", "security/login.html.twig", "D:\\Github\\Groupe6\\symfony\\projetTest\\templates\\security\\login.html.twig");
    }
}
