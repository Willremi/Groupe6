...
CREATE TABLE IF NOT EXISTS `chaussure`.`fournisseur` (
  ...
  PRIMARY KEY (`idFournisseur`, `pays_idPays`, `adresse_idAdress`),
...
CREATE TABLE IF NOT EXISTS `chaussure`.`produit` (
  ...
  PRIMARY KEY (`idProduit`, `typeproduit_idTypeProd`, `fournisseur_idFournisseur`, `client_idClient`, `client_adresse_idAdress`),
...
CREATE TABLE IF NOT EXISTS `chaussure`.`utilisateur` (
  ...
  `client_idClient` INT NOT NULL,
  `client_adresse_idAdress` INT NOT NULL,
  PRIMARY KEY (`idUser`, `adresse_idAdress`, `client_idClient`, `client_adresse_idAdress`),
